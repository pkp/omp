...
class CopyeditorHandler extends Handler {
	...
	function index($args) {
		...
		$submissions = $copyeditorSubmissionDao->getByCopyeditorId($user->getId(), $press->getId(), $searchField, $searchMatch, $search, $dateSearchField, $fromDate, $toDate, $active, $rangeInfo);
	...
	/**
	 * Validate that user is a copyeditor in the selected press.
