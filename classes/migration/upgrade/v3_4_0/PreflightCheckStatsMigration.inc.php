...
class PreflightCheckStatsMigration extends \PKP\migration\Migration
{
    ...
    public function up(): void
    {
        try {
            ...
            $orphanedIds = DB::table('metrics AS m')->leftJoin('publication_formats AS r', 'm.representation_id', '=', 'r.publication_format_id')->whereNotNull('m.representation_id')->whereNull('r.publication_format_id')->distinct()->pluck('m.representation_id');
