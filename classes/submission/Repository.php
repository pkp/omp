...
class Repository extends \PKP\submission\Repository
{
    ...
    {
        $views = parent::mapDashboardViews($types->except([DashboardView::TYPE_REVIEW_EXTERNAL, DashboardView::TYPE_REVIEW_INTERNAL]), $context, $user, $canAccessUnassignedSubmission, $selectedRoleIds);
