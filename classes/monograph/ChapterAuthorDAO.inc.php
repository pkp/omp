...
class ChapterAuthorDAO extends \PKP\db\DAO
{
     ...
     */
    public function getAuthors($publicationId = null, $chapterId = null)
    {
        $params = [];
     ...
     * @return array
     */
    public function getAuthorIdsByChapterId($chapterId)
    {
     ...
     * @return array
     */
    public function insertChapterAuthor($authorId, $chapterId, $isPrimary = false, $sequence = 0)
    {
     ...
     * @param $chapterId int
     */
    public function deleteChapterAuthorById($authorId, $chapterId = null)
    {
        $params = [(int) $authorId];
        if ($chapterId) {
            $params[] = (int) $chapterId;
     ...
     * @param $chapterId int
     */
    public function deleteChapterAuthorsByChapterId($chapterId)
    {
        $this->update(
