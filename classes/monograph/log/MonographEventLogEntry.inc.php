...
/**
 * @file classes/monograph/log/MonographEventLogEntry.inc.php
 *
...
// Log levels
define('MONOGRAPH_LOG_LEVEL_INFO', 'I');
define('MONOGRAPH_LOG_LEVEL_NOTICE', 'N');
define('MONOGRAPH_LOG_LEVEL_WARNING', 'W');
define('MONOGRAPH_LOG_LEVEL_ERROR', 'E');

// Log entry associative types. All types must be defined here
define('MONOGRAPH_LOG_TYPE_DEFAULT', 		0);
define('MONOGRAPH_LOG_TYPE_AUTHOR', 		0x01);
define('MONOGRAPH_LOG_TYPE_EDITOR', 		0x02);
define('MONOGRAPH_LOG_TYPE_REVIEW', 		0x03);
...
class MonographEventLogEntry extends DataObject {
	...
	/**
	 * Set localized log message (in the press's primary locale)
	...
	function getLogLevelString() {
		switch ($this->getData('logLevel')) {
			case MONOGRAPH_LOG_LEVEL_INFO:
				return 'submission.event.logLevel.info';
			case MONOGRAPH_LOG_LEVEL_NOTICE:
				return 'submission.event.logLevel.notice';
			case MONOGRAPH_LOG_LEVEL_WARNING:
				return 'submission.event.logLevel.warning';
			case MONOGRAPH_LOG_LEVEL_ERROR:
