...
/**
 * @defgroup seriesEditor_form
 */

/**
 * @file classes/seriesEditor/form/CreateReviewerForm.inc.php
 *
 * Copyright (c) 2003-2010 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class CreateReviewerForm
 * @ingroup seriesEditor_form
 *
...
class CreateReviewerForm extends Form {
	/** @var int The monograph this form is for */
	var $monographId;

	/**
	 * Constructor.
	 */
	function CreateReviewerForm($monographId) {
		parent::Form('seriesEditor/createReviewerForm.tpl');
