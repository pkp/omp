<?php
/**
 * @file classes/decision/types/SendInternalReview.inc.php
 *
...
class SendInternalReview extends DecisionType
{
    ...
    {
        return __('editor.submission.decision.sendInternalReview.completed.description', ['title' => $submission->getLocalizedFullTitle()]);
    }
