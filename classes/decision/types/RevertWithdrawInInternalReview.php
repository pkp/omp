...
/**
 * @file classes/decision/types/RevertWithdrawInInternalReview.php
 *
 * Copyright (c) 2014-2026 Simon Fraser University
 * Copyright (c) 2000-2026 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class RevertWithdrawInInternalReview
 *
 * @brief A decision to revert a withdrawal when the submission was withdrawn
 *   from the internal review stage.
 */
...
class RevertWithdrawInInternalReview extends RevertWithdraw
{
    use InInternalReviewRound;

    public function getDecision(): int
    {
        return Decision::REVERT_WITHDRAW_INTERNAL_REVIEW;
    }
