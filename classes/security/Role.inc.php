...
define('ROLE_ID_EDITOR',                0x00010000);
define('ROLE_ID_ACQUISITIONS_EDITOR',	0x00100000);
define('ROLE_ID_DESIGNER',		0x01000000);
define('ROLE_ID_COPYEDITOR',		0x10000000);
define('ROLE_ID_PROOFREADER',		0x00000002);
define('ROLE_ID_COMMITTEE_MEMBER',	0x00000020);
define('ROLE_ID_PRODUCTION_EDITOR',	0x00000200);
define('ROLE_ID_READER',		0x00002000);
define('ROLE_ID_DIRECTOR',		0x00020000);
