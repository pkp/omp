...
class InformationCenterNotifyForm extends PKPInformationCenterNotifyForm {
	 ...
	 * @return array
	 */
	protected function _getMailTemplate($monograph, $templateKey, $includeSignature = true) {
		if ($includeSignature)
			return new MonographMailTemplate($monograph, $templateKey);
		else
			return new MonographMailTemplate($monograph, $templateKey, null, null, null, false);
	}
}
