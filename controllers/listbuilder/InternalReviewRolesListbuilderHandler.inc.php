...
class InternalReviewRolesListbuilderHandler extends ListbuilderHandler {
	...
	function loadList(&$request) {
		...
		$roles = $flexibleRoleDao->getBySeriesId(FLEXIBLE_ROLE_SERIES_INTERNAL_REVIEW, $press->getId());
	...
	function loadPossibleItemList(&$request) {
		...
		$currentRoleIds = $flexibleRoleDao->getIdsBySeriesId(FLEXIBLE_ROLE_SERIES_INTERNAL_REVIEW, $press->getId()); // Don't include current roles
	...
	function additem(&$args, &$request) {
		...
		if(empty($flexibleRoleId)) {
			...
			$flexibleRole->addAssociatedSeries(FLEXIBLE_ROLE_SERIES_INTERNAL_REVIEW);
	...
	function deleteitems(&$args, &$request) {
		...
		foreach($args as $flexibleRoleId) {
			...
			$flexibleRole->removeAssociatedSeries(FLEXIBLE_ROLE_SERIES_INTERNAL_REVIEW);
			$flexibleRoleDao->updateObject($flexibleRole);
