...
/**
 * @file classes/controllers/listbuilder/content/announcements/AnnouncementTypeListbuilderGridCellProvider.inc.php
 *
 * Copyright (c) 2000-2012 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class AnnouncementTypeListbuilderGridCellProvider
 * @ingroup controllers_listbuilder_content_announcements
 *
