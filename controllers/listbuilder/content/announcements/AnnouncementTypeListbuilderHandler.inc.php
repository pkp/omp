...
/**
 * @file controllers/listbuilder/content/announcements/AnnouncementTypeListbuilderHandler.inc.php
 *
 * Copyright (c) 2000-2012 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class AnnouncementTypeListbuilderHandler
 * @ingroup listbuilder_content_announcements
 *
...
class AnnouncementTypeListbuilderHandler extends SetupListbuilderHandler {
	...
	function initialize(&$request) {
		...
		import('controllers.listbuilder.content.announcements.AnnouncementTypeListbuilderGridCellProvider');
	...
	*/
	function getRowDataElement(&$request, $rowId) {
		...
		import('controllers.tab.content.announcements.form.AnnouncementTypeForm');
