...
/**
 * @file controllers/tab/content/announcements/form/AnnouncementTypeForm.inc.php
 *
 * Copyright (c) 2003-2012 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class AnnouncementTypeForm
 * @ingroup controllers_tab_content_announcements
...
class AnnouncementTypeForm extends Form {
	...
	function AnnouncementTypeForm() {
		parent::Form('controllers/tab/content/announcements/form/announcementTypeForm.tpl');
