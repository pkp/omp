...
/**
 * @file controllers/grid/files/fairCopyFiles/FairCopyFilesGridRow.inc.php
 *
 * Copyright (c) 2003-2010 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class FairCopyFilesGridRow
...
class FairCopyFilesGridRow extends GridRow {
	/**
	 * Constructor
	 */
	function FairCopyFilesGridRow() {
		parent::GridRow();
	}
