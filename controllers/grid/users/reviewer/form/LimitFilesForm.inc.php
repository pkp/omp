...
class LimitFilesForm extends Form {
	...
	function fetch($request) {
		...
		$templateMgr->assign('monographId', $this->_reviewAssignment->getSubmissionId());
	...
	function execute() {
		...
		$submissionFiles = $submissionFileDao->getLatestNewRevisionsByReviewRound($this->_reviewRound, MONOGRAPH_FILE_REVIEW_FILE);
