...
class ChapterGridHandler extends CategoryGridHandler {
	...
	function ChapterGridHandler() {
		...
		$this->addRoleAssignment(
			array(ROLE_ID_AUTHOR, ROLE_ID_SERIES_EDITOR, ROLE_ID_MANAGER, ROLE_ID_ASSISTANT),
			array(
	...
	function initialize(&$request) {
		...
		AppLocale::requireComponents(LOCALE_COMPONENT_APP_DEFAULT_SETTINGS, LOCALE_COMPONENT_APP_SUBMISSION);
