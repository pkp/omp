...
class ReviewFormElementGridHandler extends SetupGridHandler {
	...
	function getRemoteOperations() {
		return array_merge(parent::getRemoteOperations(), array('createReviewFormElement', 'editReviewFormElement', 'updateReviewFormElement', 'deleteReviewFormElement'));
	}
	...
	function initialize(&$request) {
		...
		$this->addColumn(new GridColumn('reviewFormElement', 'grid.reviewFormElements.column.elements', 'controllers/grid/gridCellInSpan.tpl', $cellProvider));
