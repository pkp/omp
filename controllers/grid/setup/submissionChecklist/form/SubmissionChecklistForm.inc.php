...
/**
 * @file controllers/grid/submissionChecklist/form/SubmissionChecklistForm.inc.php
 *
...
class SubmissionChecklistForm extends Form {
	...
	function SubmissionChecklistForm($submissionChecklistId = null) {
		...
		parent::Form('controllers/grid/submissionChecklist/form/submissionChecklistForm.tpl');
