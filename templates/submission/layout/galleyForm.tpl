...
<form method="post" action="{url op="saveGalley" path=$monographId|to_array:$galleyId}" enctype="multipart/form-data">
...
<tr valign="top">
	...
	<td width="80%" class="value">{$label|escape}</td>
</tr>
...
<tr valign="top">
	...
	<td class="value"><a class="action" href="{url op="downloadFile" path=$monographId|to_array:$galley->getFileId()}">{$galley->getFileName()|escape}</a></td>
</tr>
<tr valign="top">
...
<tr valign="top">
	...
	<td width="80%" class="value"><a class="action" href="{url op="downloadFile" path=$monographId|to_array:$styleFile->getFileId()}">{$styleFile->getFileName()|escape}</a></td>
</tr>
<tr valign="top">
	<td class="label">{translate key="common.fileSize"}</td>
...
<tr valign="top">
	<td><a class="action" href="{url op="downloadFile" path=$monographId|to_array:$imageFile->getFileId()}">{$imageFile->getFileName()|escape}</a></td>
...
<p><input type="submit" value="{translate key="common.save"}" class="button defaultButton" /> <input type="button" value="{translate key="common.cancel"}" class="button" onclick="document.location.href='{url op="submissionEditing" path=$monographId escape=false}'" /></p>
