 ...
 *}
{strip}
{assign var="pageTitle" value="monograph.suppFile"}
...
{if $suppFile}
	<tr valign="top">
		...
		<td width="80%" class="value"><a href="{url op="downloadFile" path=$monographId|to_array:$suppFile->getFileId()}">{$suppFile->getFileName()|escape}</a></td>
	</tr>
	<tr valign="top">
