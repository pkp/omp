...
<table width="100%" class="data">
	<tr valign="top">
		...
		<td width="80%" class="value">
			{if $suppFileId}{url|assign:"formUrl" op="editSuppFile" path=$monographId|to_array:$suppFileId from=$from escape=false}
			{else}{url|assign:"formUrl" op="addSuppFile" path=$monographId from=$from escape=false}
			{/if}
...
{if $suppFile}
	<tr valign="top">
		...
		<td width="80%" class="data"><a href="{url op="downloadFile" path=$monographId|to_array:$suppFile->getFileId()}">{$suppFile->getFileName()|escape}</a></td>
	</tr>
	<tr valign="top">
