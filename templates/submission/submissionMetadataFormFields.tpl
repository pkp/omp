...
{fbvFormArea id="generalInformation"}
	...
	{fbvFormSection title="submission.submit.metadata"}
		{fbvElement type="keyword" id="disciplines" label="search.discipline" disabled=$readOnly}
		{fbvElement type="keyword" id="keyword" label="common.keywords" disabled=$readOnly}
		{fbvElement type="keyword" id="agencies" label="submission.supportingAgencies" disabled=$readOnly}
	{/fbvFormSection}
{/fbvFormArea}