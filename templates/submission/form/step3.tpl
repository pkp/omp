...
{capture assign="additionalContributorsFields"}
	<!--  Chapters -->
	{capture assign=chaptersGridUrl}{url router=PKPApplication::ROUTE_COMPONENT  component="grid.users.chapter.ChapterGridHandler" op="fetchGrid" submissionId=$submissionId publicationId=$publicationId escape=false}{/capture}
