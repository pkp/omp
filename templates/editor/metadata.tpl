...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td width="80%" class="value">
			...
			{url|assign:"url" page="user" op="email" redirectUrl=$currentUrl to=$emailString|to_array subject=$submission->getArticleTitle|strip_tags articleId=$submission->getMonographId()}
...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td class="value">{$submission->getMonographDescription()|strip_unsafe_html|nl2br|default:"&mdash;"}</td>
	</tr>
</table>
