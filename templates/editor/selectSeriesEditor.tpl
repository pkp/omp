<!-- templates/editor/selectSeriesEditor.tpl -->

{**
 * selectSeriesEditor.tpl
 *
...
<tr valign="bottom">
	...
	<td class="heading" width="20%">{translate key="submissions.series"}</td>
...
<tr valign="top">
	...
	<td>
		{assign var=thisEditorSeries value=$editorSeries[$editorId]}
		{foreach from=$thisEditorSeries item=series}
			{$series->getLocalizedAbbrev()|escape}&nbsp;
		{foreachelse}
			&mdash;
		{/foreach}
	</td>
	...
	<td><a class="action" href="{url op="assignEditor" monographId=$monographId editorId=$editorId}">{translate key="common.assign"}</a></td>
</tr>
