...
{url|assign:announcementGridUrl router=$smarty.const.ROUTE_COMPONENT component="grid.content.announcements.ViewAnnouncementGridHandler" op="fetchGrid" displayLimit=$displayLimit escape=false}
