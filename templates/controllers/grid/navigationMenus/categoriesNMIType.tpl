 ...
 *}
{fbvFormSection id=$smarty.const.NMI_TYPE_CATEGORY class="NMI_TYPE_CUSTOM_EDIT" title="manager.navigationMenus.form.navigationMenuItem.category" for="categorySelect"}
