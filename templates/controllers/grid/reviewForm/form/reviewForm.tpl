...
<form name="reviewFormForm" method="post" action="{url router=$smarty.const.ROUTE_COMPONENT component="grid.reviewForm.ReviewFormGridHandler" op="updateReviewForm"}">
