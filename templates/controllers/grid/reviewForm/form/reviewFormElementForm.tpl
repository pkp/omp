...
<form name="reviewFormElementForm" method="post" action="{url router=$smarty.const.ROUTE_COMPONENT component="grid.reviewForm.ReviewFormElementRowHandler" op="updateReviewFormElement"}">
