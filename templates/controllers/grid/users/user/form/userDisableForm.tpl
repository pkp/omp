 ...
 *}
<form name="userDisableForm" id="userDisableForm" method="post" action="{url router=$smarty.const.ROUTE_COMPONENT component="grid.users.user.UserGridHandler" op="disableUser"}">
