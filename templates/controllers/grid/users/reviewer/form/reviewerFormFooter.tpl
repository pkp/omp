...
<div class="reviewerFormFooterContainer">
	...
	<div id="filesAccordion">
		...
		<div>
			...
			{url|assign:limitReviewFilesGridUrl router=$smarty.const.ROUTE_COMPONENT component="grid.files.review.LimitReviewFilesGridHandler" op="fetchGrid" monographId=$monographId stageId=$stageId reviewRoundId=$reviewRoundId escape=false}
