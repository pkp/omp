...
<form id="uploadForm" class="pkp_controllers_form" action="{url op="updateFile" fileType=$libraryFile->getType() fileId=$libraryFile->getId()}" method="post" class="pkp_controllers_form">
	{fbvFormArea id="name"}
