 ...
 *}
{capture assign=dependentFilesGridUrl}{url router=$smarty.const.ROUTE_COMPONENT component="grid.files.dependent.DependentFilesGridHandler" op="fetchGrid" submissionId=$submissionId submissionFileId=$submissionFile->getId() stageId=$smarty.const.WORKFLOW_STAGE_ID_PRODUCTION isGridDisabled=$isGridDisabled escape=false}{/capture}
