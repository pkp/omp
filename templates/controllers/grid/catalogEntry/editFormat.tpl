...
<div id="editPublicationFormatMetadataTabs">
	<ul>
		<li><a href="{url router=$smarty.const.ROUTE_COMPONENT op="editFormatTab" submissionId=$submissionId representationId=$representationId publicationId=$publicationId formDisabled=$formDisabled}">{translate key="common.edit"}</a></li>
		{if !$formDisabled}
			<li><a href="{url router=$smarty.const.ROUTE_COMPONENT op="editFormatMetadata" submissionId=$submissionId representationId=$representationId publicationId=$publicationId formDisabled=$formDisabled}">{translate key="submission.informationCenter.metadata"}</a></li>
		{/if}
