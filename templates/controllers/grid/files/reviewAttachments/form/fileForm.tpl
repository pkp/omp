	...
	{fbvFormArea id="buttons"}
		{fbvFormSection}
			{if !$rowId}
				...
				{fbvButton id="continueButton-$randomId" label="common.saveAndClose" disabled="disabled" float=$fbvStyles.float.RIGHT}
			{else}
				{fbvButton id="okButton-$randomId" label="common.ok" float=$fbvStyles.float.LEFT}
			{/if}
		{/fbvFormSection}
	{/fbvFormArea}
</form>
