...
{literal}
	$(function() {
		...
		$('#reviewerFilterForm-{/literal}{$timeStamp}{literal}').ajaxForm({
		        ...
		        success: function(returnString) {
		    		...
		    		if (returnString.status == true) {
		    			$('#reviewerSelectGridContainer-{/literal}{$timeStamp}{literal}').html(returnString.content);
		    		}
...
<form name="reviewerFilterForm" id="reviewerFilterForm-{$timeStamp}" action="{url router=$smarty.const.ROUTE_COMPONENT component="grid.users.reviewerSelect.ReviewerSelectGridHandler" op="updateReviewerSelect"}" method="post">
...
{assign var=gridContainerId value="reviewerSelectGridContainer"|concat:"-":$timeStamp}
