		...
		$('#reviewerFilterForm-{/literal}{$randomId}{literal}').ajaxForm({
		        ...
		        success: function(returnString) {
		    		...
		    		if (returnString.status == true) {
		    			$('#reviewerSelectGridContainer-{/literal}{$randomId}{literal}').html(returnString.content);
		    		}
...
<form name="reviewerFilterForm" id="reviewerFilterForm-{$randomId}" action="{url router=$smarty.const.ROUTE_COMPONENT component="grid.users.reviewerSelect.ReviewerSelectGridHandler" op="updateReviewerSelect"}" method="post">
