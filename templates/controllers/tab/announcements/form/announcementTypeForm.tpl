{**
 * templates/controllers/tab/announcements/form/announcementTypeForm.tpl
 *
...
<form class="pkp_form" id="announcementTypeForm" method="post" action="{url router=$smarty.const.ROUTE_COMPONENT component="tab.announcements.AnnouncementTabHandler" op="saveFormData" tab="announcementTypes"}">
