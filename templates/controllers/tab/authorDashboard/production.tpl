...
{if $submission->getData('stageId') >= $smarty.const.WORKFLOW_STAGE_ID_PRODUCTION}
	...
	{if $canAccessProductionStage}
		{capture assign=representationsGridUrl}{url router=PKP\core\PKPApplication::ROUTE_COMPONENT component="grid.catalogEntry.PublicationFormatGridHandler" op="fetchGrid" submissionId=$submission->getId() stageId=$smarty.const.WORKFLOW_STAGE_ID_PRODUCTION escape=false}{/capture}
