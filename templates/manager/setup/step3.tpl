...
<script type="text/javascript">
	$(function() {ldelim}
		...
		$('#setupFormStep3').pkpHandler('$.pkp.controllers.form.FormHandler');
	{rdelim});
</script>

	<form id="setupFormStep3" class="pkp_controllers_form" method="post" action="{url op="saveSetup" path="3"}" enctype="multipart/form-data">
