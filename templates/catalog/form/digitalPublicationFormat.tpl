...
{fbvFormArea id="productDimensions" title="monograph.publicationFormat.digitalInformation" border="true"}
	{fbvFormSection for="digitalInformation"}
		{fbvElement type="text" label="monograph.publicationFormat.productFileSize" name="fileSize" id="fileSize" value=$fileSize|escape maxlength="255" size=$fbvStyles.size.MEDIUM inline="true" required="true"}
