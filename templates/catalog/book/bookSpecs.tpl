...
<div class="bookSpecs">
	...
	<a title="{$publishedMonograph->getLocalizedFullTitle()|escape}" href="{$bookImageLinkUrl}"><img class="pkp_helpers_container_center" alt="{$publishedMonograph->getLocalizedFullTitle()|escape}" src="{url router=$smarty.const.ROUTE_COMPONENT component="submission.CoverHandler" op="catalog" monographId=$publishedMonograph->getId()}" /></a>
