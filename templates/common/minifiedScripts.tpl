...
<script src="{$baseUrl}/js/controllers/informationCenter/HistoryHandler.js"></script>
<script src="{$baseUrl}/js/controllers/informationCenter/NotesHandler.js"></script>
<script src="{$baseUrl}/js/controllers/informationCenter/SignoffNotesHandler.js"></script>
<script src="{$baseUrl}/js/controllers/informationCenter/form/InformationCenterNotifyHandler.js"></script>
...
<script src="{$baseUrl}/js/controllers/tab/settings/announcements/form/AnnouncementSettingsFormHandler.js"></script>
<script src="{$baseUrl}/js/controllers/tab/settings/paymentMethod/PaymentMethodHandler.js"></script>
...
<script src="{$baseUrl}/js/controllers/dashboard/form/DashboardTaskFormHandler.js"></script>
