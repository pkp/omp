...
<script type="text/javascript" src="{$baseUrl}/lib/pkp/js/lib/jquery/plugins/jquery.scrollabletab.js"></script>
...
<script type="text/javascript" src="{$baseUrl}/lib/pkp/js/controllers/tab/settings/form/FileViewFormHandler.js"></script>
...
<script type="text/javascript" src="{$baseUrl}/js/controllers/modals/editorDecision/ApproveProofsHandler.js"></script>
...
<script type="text/javascript" src="{$baseUrl}/js/controllers/grid/files/SelectableSubmissionFileListCategoryGridFilterHandler.js"></script>
...
<script type="text/javascript" src="{$baseUrl}/js/controllers/monographList/MonographListHandler.js"></script>
<script type="text/javascript" src="{$baseUrl}/js/pages/authorDashboard/AuthorDashboardHandler.js"></script>
<script type="text/javascript" src="{$baseUrl}/js/pages/authorDashboard/MonographEmailHandler.js"></script>
<script type="text/javascript" src="{$baseUrl}/js/pages/index/HeaderHandler.js"></script>
<script type="text/javascript" src="{$baseUrl}/js/pages/catalog/CarouselHandler.js"></script>
<script type="text/javascript" src="{$baseUrl}/js/pages/catalog/MonographPublicListHandler.js"></script>
...
<script type="text/javascript" src="{$baseUrl}/js/pages/manageCatalog/MonographManagementListHandler.js"></script>
