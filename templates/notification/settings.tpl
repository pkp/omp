...
<ul>
	...
	<ul class="plain">
		<li><span>
				<input type="checkbox" name="notificationMonographSubmitted"{if !$smarty.const.NOTIFICATION_TYPE_MONOGRAPH_SUBMITTED|in_array:$notificationSettings} checked="checked"{/if} />
				{translate key="notification.allow"}
			</span></li>
		<li><span>
				<input type="checkbox" name="emailNotificationMonographSubmitted"{if $smarty.const.NOTIFICATION_TYPE_MONOGRAPH_SUBMITTED|in_array:$emailSettings} checked="checked"{/if} />
...
<ul>
	...
	<ul class="plain">
		<li><span>
				<input type="checkbox" name="notificationPublishedMonograph"{if !$smarty.const.NOTIFICATION_TYPE_PUBLISHED_MONOGRAPH|in_array:$notificationSettings} checked="checked"{/if} />
				{translate key="notification.allow"}
			</span></li>
		<li><span>
				<input type="checkbox" name="emailNotificationPublishedMonograph"{if $smarty.const.NOTIFICATION_TYPE_PUBLISHED_MONOGRAPH|in_array:$emailSettings} checked="checked"{/if} />
				{translate key="notification.email"}
			</span></li>
	</ul>
	</li>
