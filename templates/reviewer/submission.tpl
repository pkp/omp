...
<tr valign="top">
	...
	<td width="97%"><span class="instruct">{translate key="reviewer.monograph.notifyEditorA"}{if $firstEditAssignment}, {$firstEditAssignment->getEditorFullName()|escape},{/if} {translate key="reviewer.monograph.notifyEditorB"}</span></td>
</tr>
<tr valign="top">
	<td>&nbsp;</td>
	<td>
