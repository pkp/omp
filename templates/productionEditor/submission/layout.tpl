...
<table width="100%" class="info">
	...
	<tr>
		...
		<td width="26%">{$galley->getGalleyLabel()|escape} &nbsp; <a href="{url op="proofGalley" path=$submission->getMonographId()|to_array:$galley->getId()}" class="action">{translate key="submission.layout.viewProof"}</a></td>
		...
		<td><a href="{url op="orderGalley" d=u monographId=$submission->getMonographId() galleyId=$galley->getId()}" class="plain">&uarr;</a> <a href="{url op="orderGalley" d=d monographId=$submission->getMonographId() galleyId=$galley->getId()}" class="plain">&darr;</a></td>
		<td>
