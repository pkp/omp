...
{url|assign:submissionFilesGridUrl router=$smarty.const.ROUTE_COMPONENT component="grid.submissions.submissionFiles.SubmissionFilesGridHandler" op="fetchGrid" monographId=$monographId}
