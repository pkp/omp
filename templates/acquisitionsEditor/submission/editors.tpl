...
<table width="100%" class="listing">
	...
	{/if}
		<tr valign="top">
			<td>{if $editAssignment->getIsEditor()}{translate key="user.role.editor"}{else}{assign var=acqEdListed value=1}{translate key="user.role.acquisitionsEditor"}{/if}</td>
			<td>
...
{if $isEditor}
	...
	<a href="{url op="assignEditor" path="acquisitionsEditor" monographId=$submission->getMonographId()}" class="action">{translate key="editor.monograph.assignAcquisitionsEditor"}</a>
