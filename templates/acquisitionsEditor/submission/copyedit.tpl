	...
	<tr>
		...
		<td colspan="5">
			...
			{if $initialCopyeditFile}
				<a href="{url op="downloadFile" path=$submission->getMonographId()|to_array:$initialCopyeditFile->getFileId():$initialCopyeditFile->getRevision()}" class="file">{$initialCopyeditFile->getFileName()}</a>&nbsp;&nbsp;{$initialCopyeditFile->getDateModified()|date_format:$dateFormatShort}
			{else}
