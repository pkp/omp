	...
	{if $reviewFile}
		<tr valign="top">
			...
			<td width="50%" class="value">
				...
				{/if}
				<a href="{url op="downloadFile" path=$submission->getMonographId()|to_array:$reviewFile->getFileId():$reviewFile->getRevision()}" class="file">{$reviewFile->getFileName()}</a>&nbsp;&nbsp;
