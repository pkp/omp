 ...
 *}
{strip}
{translate|assign:"pageTitleTranslated" key="seriesEditor.regrets.title" monographId=$submission->getMonographId()}
{assign var=pageTitleTranslated value=$pageTitleTranslated|escape}
{assign var="pageCrumbTitle" value="seriesEditor.regrets.breadcrumb"}
