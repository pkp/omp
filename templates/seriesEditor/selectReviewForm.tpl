 ...
 *}
{strip}
{assign var="pageTitle" value="editor.monograph.reviewForms"}
{include file="common/header.tpl"}
{/strip}

<h3>{translate key="editor.monograph.selectReviewForm"}</h3>
