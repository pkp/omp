...
<div id=accessTabs>
	<ul>
		...
		<li><a href="{url router=$smarty.const.ROUTE_COMPONENT component="tab.settings.PressSettingsTabHandler" op="showTab" tab="categoriesAndSeries"}">{translate key="manager.setup.categoriesAndSeries"}</a></li>
