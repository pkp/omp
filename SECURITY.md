...
PKP then discloses the vulnerability publicly by updating the Github issue entry with complete details and adding a notice about the vulnerability to the software download page (e.g. https://pkp.sfu.ca/omp/omp_download/). At this point, a CVE and credit for the discovery may be added to the entry.
