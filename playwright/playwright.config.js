 ...
 *
 * OMP's Playwright configuration. Everything of substance lives in the shared
 * factory; this file only says which app this is and where it listens.
 *
 * Port 8100 is OMP's slot in the fleet (OJS 8000, OPS 8200) — the three suites
...
module.exports = definePkpConfig({
	...
	basePort: Number(process.env.PLAYWRIGHT_BASE_PORT || 8100),
});
