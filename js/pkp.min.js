...
this.gridHandler.getCategoryDataIdByRowId(b[e]);f=this.gridHandler.getCategoryIdPrefix()+f;-1<a.inArray(f,d)||d.push(f)}return d}})(jQuery);(function(a){a.pkp.classes.features.OrderListbuilderItemsFeature=function(b,c){this.parent(b,c)};a.pkp.classes.Helper.inherits(a.pkp.classes.features.OrderListbuilderItemsFeature,a.pkp.classes.features.OrderItemsFeature);a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.addFeatureHtml=function(b,c){var d;this.parent("addFeatureHtml",b,c);b=this.getSequenceInput_();c=this.gridHandler.getRows();var e=0;for(d=c.length;e<d;e++){var f=a(c[e]);var k=b.clone();a("td.first_column",f).append(k)}};
a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.setupSortablePlugin=function(){this.applySortPlgOnElements(this.getGridHtmlElement(),"tr.orderable",null)};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.init=function(){this.parent("init");this.toggleItemsDragMode()};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.toggleState=function(b){this.parent("toggleState",b);this.toggleContentHandlers_()};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.storeRowOrder=
function(b,c){b+=1;c.find(".itemSequence").attr("value",b);c.find(".isModified").attr("value",1)};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.saveOrderHandler=function(){this.parent("saveOrderHandler");this.toggleState(!1);return!1};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.updateOrderCallback=function(b,c,d){this.parent("updateOrderCallback");b=this.gridHandler.getRows();this.storeOrder(b)};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.clickOrderHandler=
function(){var b=a("select:visible",this.getGridHtmlElement()),c;if(0<b.length){var d=0;for(c=b.length;d<c;d++)this.gridHandler.saveRow(a(b[d]).parents(".gridRow"))}return this.parent("clickOrderHandler")};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.addElement=function(b){this.parent("addElement",b);this.formatAndStoreNewRow_(b);return!1};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.replaceElement=function(b){this.parent("replaceElement",b);this.formatAndStoreNewRow_(b);
return!1};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.getSequenceInput_=function(){return a('<input type="hidden" name="newRowId[sequence]" class="itemSequence" />')};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.toggleContentHandlers_=function(){var b=this.gridHandler.getRows(),c;var d=0;for(c=b.length;d<c;d++){var e=a(b[d]);this.isOrdering?e.find(".gridCellDisplay").unbind("click"):this.gridHandler.attachContentHandlers_(e)}};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.formatAndStoreNewRow_=
function(b){b.children().after(this.getSequenceInput_());b=this.gridHandler.getRows();this.storeOrder(b)}})(jQuery);(function(a){a.pkp.classes.features.GeneralPagingFeature=function(b,c){c.defaultItemsPerPage=parseInt(c.defaultItemsPerPage,10);c.currentItemsPerPage=parseInt(c.currentItemsPerPage,10);c.itemsTotal=c.itemsTotal?parseInt(c.itemsTotal,10):0;c.currentPage=parseInt(c.currentPage,10);this.parent(b,c)};a.pkp.classes.Helper.inherits(a.pkp.classes.features.GeneralPagingFeature,a.pkp.classes.features.Feature);a.pkp.classes.features.GeneralPagingFeature.prototype.getOptions=function(){return this.parent("getOptions")};
...
function(b,c){b=this.getHtmlElement();0<parseInt(b.find("#revisedFileId").val(),10)&&(b.submit(),c.preventDefault())};a.pkp.controllers.wizard.fileUpload.form.RevisionConfirmationHandler.prototype.handleResponse=function(b,c){!0===c.status&&this.trigger("fileUploaded",c.uploadedFile);return this.parent("handleResponse",b,c)}})(jQuery);(function(a){a.pkp.controllers.grid.notifications=a.pkp.controllers.grid.notifications||{};a.pkp.controllers.grid.notifications.NotificationsGridHandler=function(b,c){b.find('a[id*="markNew"]').click(this.callbackWrapper(this.markNewHandler_));b.find('a[id*="markRead"]').click(this.callbackWrapper(this.markReadHandler_));b.find('a[id*="deleteNotification"]').click(this.callbackWrapper(this.deleteHandler_));this.parent(b,c)};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.notifications.NotificationsGridHandler,
...
d.filter('input[value="'+b+'"]').parent().addClass("optionalColumn")}})(jQuery);jQuery.pkp.pages.submission=jQuery.pkp.pages.submission||{};
