...
this.gridHandler.getCategoryDataIdByRowId(b[e]);k=this.gridHandler.getCategoryIdPrefix()+k;-1<a.inArray(k,d)||d.push(k)}return d}})(jQuery);(function(a){a.pkp.classes.features.OrderListbuilderItemsFeature=function(b,c){this.parent(b,c)};a.pkp.classes.Helper.inherits(a.pkp.classes.features.OrderListbuilderItemsFeature,a.pkp.classes.features.OrderItemsFeature);a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.addFeatureHtml=function(b,c){var d;this.parent("addFeatureHtml",b,c);b=this.getSequenceInput_();c=this.gridHandler.getRows();var e=0;for(d=c.length;e<d;e++){var k=a(c[e]);var t=b.clone();a("td.first_column",k).append(t)}};
...
function(b){var c=a("[id^='recommendOnly']",this.getHtmlElement()),d,e=!1;for(d=0;d<this.recommendOnlyRoleIds_.length;d++)this.recommendOnlyRoleIds_[d]==b&&(e=!0);e?c.removeAttr("disabled"):(c.attr("disabled","disabled"),c.removeAttr("checked"))}})(jQuery);(function(a){a.pkp.controllers.tab=a.pkp.controllers.tab||{};a.pkp.controllers.tab.workflow=a.pkp.controllers.tab.workflow||{};a.pkp.controllers.tab.workflow.WorkflowTabHandler=function(b,c){var d,e;this.parent(b,c);if(d=document.location.toString().match("workflow/([^/]+)/")){d=d[1];var k=b.find("li a");for(e=0;e<k.length;e++)b=new RegExp(d),k[e].getAttribute("class").match(b)&&(c.selected=e)}};a.pkp.classes.Helper.inherits(a.pkp.controllers.tab.workflow.WorkflowTabHandler,a.pkp.controllers.TabHandler)})(jQuery);(function(a){a.pkp.controllers.dashboard=a.pkp.controllers.dashboard||{form:{}};a.pkp.controllers.dashboard.form.DashboardTaskFormHandler=function(b,c){this.parent(b,c);this.singleContextSubmissionUrl_=c.singleContextSubmissionUrl;a("#singleContext",b).click(this.callbackWrapper(this.startSingleContextSubmission_));a("#multipleContext",b).change(this.callbackWrapper(this.startMultipleContextSubmission_))};a.pkp.classes.Helper.inherits(a.pkp.controllers.dashboard.form.DashboardTaskFormHandler,a.pkp.controllers.form.FormHandler);
