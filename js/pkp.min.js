...
arguments);var a=this.prop.apply(this,arguments);return a&&a.jquery||"string"===typeof a?a:this.attr.apply(this,arguments)};a.fn.ajaxSubmit=function(c){function b(e){function f(a){var c=null;try{a.contentWindow&&(c=a.contentWindow.document)}catch(b){d("cannot get iframe.contentWindow document: "+b)}if(c)return c;try{c=a.contentDocument?a.contentDocument:a.document}catch(e){d("cannot get iframe.contentDocument: "+e),c=a.document}return c}function g(){function c(){try{var a=f(n).readyState;d("state = "+
a);a&&"uninitialized"==a.toLowerCase()&&setTimeout(c,50)}catch(b){d("Server abort: ",b," (",b.name,")"),w(I),G&&clearTimeout(G),G=void 0}}var b=q.attr2("target"),e=q.attr2("action"),B=q.attr("enctype")||q.attr("encoding")||"multipart/form-data";i.setAttribute("target",y);(!m||/post/i.test(m))&&i.setAttribute("method","POST");e!=l.url&&i.setAttribute("action",l.url);!l.skipEncodingOverride&&(!m||/post/i.test(m))&&q.attr({encoding:"multipart/form-data",enctype:"multipart/form-data"});l.timeout&&(G=
...
w):n.addEventListener("load",w,!1);setTimeout(c,15);try{i.submit()}catch(z){document.createElement("form").submit.apply(i)}}finally{i.setAttribute("action",e),i.setAttribute("enctype",B),b?i.setAttribute("target",b):q.removeAttr("target"),a(h).remove()}}function w(c){if(!r.aborted&&!P)if(z=f(n),z||(d("cannot access response document"),c=I),c===O&&r)r.abort("timeout"),B.reject(r,"timeout");else if(c==I&&r)r.abort("server abort"),B.reject(r,"error","server abort");else if(z&&z.location.href!=l.iframeSrc||
E){n.detachEvent?n.detachEvent("onload",w):n.removeEventListener("load",w,!1);var c="success",b;try{if(E)throw"timeout";var e="xml"==l.dataType||z.XMLDocument||a.isXMLDoc(z);d("isXml="+e);if(!e&&(window.opera&&(null===z.body||!z.body.innerHTML))&&--T){d("requeing onLoad callback, DOM not available");setTimeout(w,250);return}var g=z.body?z.body:z.documentElement;r.responseText=g?g.innerHTML:null;r.responseXML=z.XMLDocument?z.XMLDocument:z;e&&(l.dataType="xml");r.getResponseHeader=function(a){return{"content-type":l.dataType}[a.toLowerCase()]};
...
{},l.extraData[v]=e.value,"image"==e.type&&(l.extraData[v+".x"]=i.clk_x,l.extraData[v+".y"]=i.clk_y);var O=1,I=2,e=a("meta[name=csrf-token]").attr("content");if((v=a("meta[name=csrf-param]").attr("content"))&&e)l.extraData=l.extraData||{},l.extraData[v]=e;l.forceSync?g():setTimeout(g,10);var C,z,T=50,P,t=a.parseXML||function(a,c){window.ActiveXObject?(c=new ActiveXObject("Microsoft.XMLDOM"),c.async="false",c.loadXML(a)):c=(new DOMParser).parseFromString(a,"text/xml");return c&&c.documentElement&&
"parsererror"!=c.documentElement.nodeName?c:null},A=a.parseJSON||function(a){return window.eval("("+a+")")};return B}if(!this.length)return d("ajaxSubmit: skipping submit process - no element selected"),this;var m,k,q=this;"function"==typeof c?c={success:c}:void 0===c&&(c={});m=c.type||this.attr2("method");k=c.url||this.attr2("action");(k=(k="string"===typeof k?a.trim(k):"")||window.location.href||"")&&(k=(k.match(/^([^#]+)/)||[])[1]);c=a.extend(!0,{url:k,success:a.ajaxSettings.success,type:m||a.ajaxSettings.type,
iframeSrc:/^https/i.test(window.location.href||"")?"javascript:false":"about:blank"},c);k={};this.trigger("form-pre-serialize",[this,c,k]);if(k.veto)return d("ajaxSubmit: submit vetoed via form-pre-serialize trigger"),this;if(c.beforeSerialize&&!1===c.beforeSerialize(this,c))return d("ajaxSubmit: submit aborted via beforeSerialize callback"),this;var p=c.traditional;void 0===p&&(p=a.ajaxSettings.traditional);var s=[],n,t=this.formToArray(c.semantic,s);c.data&&(c.extraData=c.data,n=a.param(c.data,
p));if(c.beforeSubmit&&!1===c.beforeSubmit(t,this,c))return d("ajaxSubmit: submit aborted via beforeSubmit callback"),this;this.trigger("form-submit-validate",[t,this,c,k]);if(k.veto)return d("ajaxSubmit: submit vetoed via form-submit-validate trigger"),this;k=a.param(t,p);n&&(k=k?k+"&"+n:n);"GET"==c.type.toUpperCase()?(c.url+=(0<=c.url.indexOf("?")?"&":"?")+k,c.data=null):c.data=k;var u=[];c.resetForm&&u.push(function(){q.resetForm()});c.clearForm&&u.push(function(){q.clearForm(c.includeHidden)});
if(!c.dataType&&c.target){var g=c.success||function(){};u.push(function(b){var d=c.replaceTarget?"replaceWith":"html";a(c.target)[d](b).each(g,arguments)})}else c.success&&u.push(c.success);c.success=function(a,b,d){for(var e=c.context||this,f=0,g=u.length;f<g;f++)u[f].apply(e,[a,b,d||q,q])};if(c.error){var D=c.error;c.error=function(a,b,d){D.apply(c.context||this,[a,b,d,q])}}if(c.complete){var w=c.complete;c.complete=function(a,b){w.apply(c.context||this,[a,b,q])}}n=0<a("input[type=file]:enabled",
this).filter(function(){return""!==a(this).val()}).length;k="multipart/form-data"==q.attr("enctype")||"multipart/form-data"==q.attr("encoding");p=e&&f;d("fileAPI :"+p);var v;if(!1!==c.iframe&&(c.iframe||(n||k)&&!p))c.closeKeepAlive?a.get(c.closeKeepAlive,function(){v=b(t)}):v=b(t);else if((n||k)&&p){var l=new FormData;for(k=0;k<t.length;k++)l.append(t[k].name,t[k].value);if(c.extraData){k=a.param(c.extraData,c.traditional).split("&");p=k.length;n=[];var y,E;for(y=0;y<p;y++)k[y]=k[y].replace(/\+/g,
" "),E=k[y].split("="),n.push([decodeURIComponent(E[0]),decodeURIComponent(E[1])]);for(k=0;k<n.length;k++)n[k]&&l.append(n[k][0],n[k][1])}c.data=null;n=a.extend(!0,{},a.ajaxSettings,c,{contentType:!1,processData:!1,cache:!1,type:m||"POST"});c.uploadProgress&&(n.xhr=function(){var b=a.ajaxSettings.xhr();b.upload&&b.upload.addEventListener("progress",function(a){var b=0,d=a.loaded||a.position,e=a.total;a.lengthComputable&&(b=Math.ceil(100*(d/e)));c.uploadProgress(a,d,e,b)},!1);return b});n.data=null;
var A=n.beforeSend;n.beforeSend=function(a,b){b.data=c.formData?c.formData:l;A&&A.call(this,a,b)};v=a.ajax(n)}else v=a.ajax(c);q.removeData("jqxhr").data("jqxhr",v);for(n=0;n<s.length;n++)s[n]=null;this.trigger("form-submit-notify",[this,c]);return this};a.fn.ajaxForm=function(e){e=e||{};e.delegation=e.delegation&&a.isFunction(a.fn.on);if(!e.delegation&&0===this.length){var f=this.selector,h=this.context;if(!a.isReady&&f)return d("DOM not ready, queuing ajaxForm"),a(function(){a(f,h).ajaxForm(e)}),
...
else c=a('<li class="selectBox-optgroup" />'),c.text(a(this).attr("label")),b.append(c),b=e(a(this),b)});return b};switch(b){case "inline":return d=a('<ul class="selectBox-options" />'),d=e(c,d),d.find("A").bind("mouseover.selectBox",function(){s(c,a(this).parent())}).bind("mouseout.selectBox",function(){n(c,a(this).parent())}).bind("mousedown.selectBox",function(a){a.preventDefault();c.selectBox("control").hasClass("selectBox-active")||c.selectBox("control").focus()}).bind("mouseup.selectBox",function(b){q();
...
b.screenY===d.data("selectBox-down-at-y")||(d.removeData("selectBox-down-at-x").removeData("selectBox-down-at-y"),p(c,a(this).parent()),q())}).bind("mouseover.selectBox",function(){s(c,a(this).parent())}).bind("mouseout.selectBox",function(){n(c,a(this).parent())});var f=c.attr("class")||"";if(""!==f){var f=f.split(" "),g;for(g in f)d.addClass(f[g]+"-selectBox-dropdown-menu")}D(d);return d}},j=function(c){return("selectBox-label "+(a(c).find("OPTION:selected").attr("class")||"")).replace(/\s+$/,"")},
i=function(c){return a(c).find("OPTION:selected").text()||"\u00a0"},m=function(c){var c=a(c),b=c.data("selectBox-control");b&&b.find(".selectBox-label").attr("class",j(c)).text(i(c))},k=function(c){var c=a(c),b=c.data("selectBox-control"),d=c.data("selectBox-settings"),e=b.data("selectBox-options");if(b.hasClass("selectBox-disabled"))return!1;q();var f=isNaN(b.css("borderBottomWidth"))?0:parseInt(b.css("borderBottomWidth"));e.width(b.innerWidth()).css({top:b.offset().top+b.outerHeight()-f,left:b.offset().left});
...
var g=0,h=[];c.attr("multiple")?e.find(".selectBox-selected A").each(function(){h[g++]=a(this).attr("rel")}):h=b.find("A").attr("rel");e.data("selectBox-last-selected",b);c.val()!==h&&(c.val(h),m(c),c.trigger("change"));return!0},s=function(c,b){c=a(c);b=a(b);c.data("selectBox-control").data("selectBox-options").find(".selectBox-hover").removeClass("selectBox-hover");b.addClass("selectBox-hover")},n=function(c,b){c=a(c);a(b);c.data("selectBox-control").data("selectBox-options").find(".selectBox-hover").removeClass("selectBox-hover")},
...
f=d.data("selectBox-options"),g=c.data("selectBox-settings"),h=0,i=0;if(!d.hasClass("selectBox-disabled"))switch(b.keyCode){case 8:b.preventDefault();e="";break;case 9:case 27:q();n(c);break;case 13:d.hasClass("selectBox-menuShowing")?(p(c,f.find("LI.selectBox-hover:first"),b),d.hasClass("selectBox-dropdown")&&q()):k(c);break;case 38:case 37:b.preventDefault();if(d.hasClass("selectBox-menuShowing")){d=f.find(".selectBox-hover").prev("LI");h=f.find("LI:not(.selectBox-optgroup)").length;for(i=0;(0===
...
"inline",d=h(c,f),e.data("selectBox-options",d),f){case "inline":e.append(d);break;case "dropdown":m(c),a("BODY").append(d)}});break;case "value":if(void 0===b)return a(this).val();a(this).each(function(){var c,d=b;c=a(this);c.val(d);d=c.val();null===d&&(d=c.children().first().val(),c.val(d));var e=c.data("selectBox-control");if(e){var f=c.data("selectBox-settings"),e=e.data("selectBox-options");m(c);e.find(".selectBox-selected").removeClass("selectBox-selected");e.find("A").each(function(){if("object"===
...
d){if(b>d||void 0===b)return 1;if(b<d||void 0===d)return-1}return a.index-c.index}),"value")};var H=function(a){return function(c,b,d){var e={},b=w(b,d);g.each(c,function(d,f){var g=b(d,f,c);a(e,d,g)});return e}};g.groupBy=H(function(a,c,b){g.has(a,b)?a[b].push(c):a[b]=[c]});g.indexBy=H(function(a,c,b){a[b]=c});g.countBy=H(function(a,c,b){g.has(a,b)?a[b]++:a[b]=1});g.toArray=function(a){return!a?[]:g.isArray(a)?m.call(a):x(a)?g.map(a,g.identity):g.values(a)};g.size=function(a){return null==a?0:x(a)?
a.length:g.keys(a).length};g.partition=function(a,c,b){var c=w(c,b),d=[],e=[];g.each(a,function(a,b,f){(c(a,b,f)?d:e).push(a)});return[d,e]};g.first=g.head=g.take=function(a,c,b){return null==a?void 0:null==c||b?a[0]:g.initial(a,a.length-c)};g.initial=function(a,c,b){return m.call(a,0,Math.max(0,a.length-(null==c||b?1:c)))};g.last=function(a,c,b){return null==a?void 0:null==c||b?a[a.length-1]:g.rest(a,Math.max(0,a.length-c))};g.rest=g.tail=g.drop=function(a,c,b){return m.call(a,null==c||b?1:c)};g.compact=
function(a){return g.filter(a,g.identity)};var F=function(a,c,b,d){for(var e=[],f=0,d=d||0,h=A(a);d<h;d++){var i=a[d];if(x(i)&&(g.isArray(i)||g.isArguments(i))){c||(i=F(i,c,b));var j=0,k=i.length;for(e.length+=k;j<k;)e[f++]=i[j++]}else b||(e[f++]=i)}return e};g.flatten=function(a,c){return F(a,c,!1)};g.without=function(a){return g.difference(a,m.call(arguments,1))};g.uniq=g.unique=function(a,c,b,d){g.isBoolean(c)||(d=b,b=c,c=!1);null!=b&&(b=w(b,d));for(var d=[],e=[],f=0,h=A(a);f<h;f++){var i=a[f],
...
b||1,c=Math.max(Math.ceil((c-a)/b),0),d=Array(c),e=0;e<c;e++,a+=b)d[e]=a;return d};var M=function(a,c,b,d,e){if(!(d instanceof c))return a.apply(b,e);c=l(a.prototype);a=a.apply(c,e);return g.isObject(a)?a:c};g.bind=function(a,c){if(n&&a.bind===n)return n.apply(a,m.call(arguments,1));if(!g.isFunction(a))throw new TypeError("Bind must be called on a function");var b=m.call(arguments,2),d=function(){return M(a,d,c,this,b.concat(m.call(arguments)))};return d};g.partial=function(a){var c=m.call(arguments,
...
{};return b};g.delay=function(a,c){var b=m.call(arguments,2);return setTimeout(function(){return a.apply(null,b)},c)};g.defer=g.partial(g.delay,g,1);g.throttle=function(a,c,b){var d,e,f,h=null,i=0;b||(b={});var j=function(){i=!1===b.leading?0:g.now();h=null;f=a.apply(d,e);h||(d=e=null)};return function(){var k=g.now();!i&&!1===b.leading&&(i=k);var l=c-(k-i);d=this;e=arguments;0>=l||l>c?(h&&(clearTimeout(h),h=null),i=k,f=a.apply(d,e),h||(d=e=null)):!h&&!1!==b.trailing&&(h=setTimeout(j,l));return f}};
...
this.$linkActionElement.focus();this.$modal_.remove();return this.parent("finish")}})(jQuery);(function(a){a.pkp.classes.notification=a.pkp.classes.notification||{};a.pkp.classes.notification.NotificationHelper=function(){};a.pkp.classes.notification.NotificationHelper.redirectNotifyUserEvent=function(c,b){var d,e,f,h,j,i,m,k,q,p,s;if(void 0!==b.content)c.getHtmlElement().parent().trigger("notifyUser",[b]);else{d=c.getHtmlElement();e=!1;!(c instanceof a.pkp.controllers.SiteHandler)&&0<a(b).parents(".pkp_controllers_grid").length&&(d.parent().trigger("notifyUser"),e=!0);d=a(".pkp_notification",
d);f=[];h=0;for(j=d.length;h<j;h++)if(m=a(d[h]),!(0<m.parents(":hidden").length)){i=m.parents();q=0;for(p=i.length;q<p;q++)if(k=a(i[q]).data("pkp.handler"),k instanceof a.pkp.classes.Handler){s=a(i[q]);break}if(s.has(b[0]).length||s[0]===b[0]){if(0<m.parents(".ui-accordion:first").length&&(i=m.parents(".ui-accordion:first"),!i.has(b[0])))continue;f.push(m)}}if(f.length)for(h=f.length-1;-1<h;h--)f[h].triggerHandler("notifyUser");else e||c.getHtmlElement().parent().trigger("notifyUser")}}})(jQuery);(function(a){a.pkp.classes.features=a.pkp.classes.features||{};a.pkp.classes.features.Feature=function(a,b){this.gridHandler=a;this.options_=b;this.addFeatureHtml(this.getGridHtmlElement(),b)};a.pkp.classes.features.Feature.prototype.gridHandler=null;a.pkp.classes.features.Feature.prototype.options_=null;a.pkp.classes.features.Feature.prototype.setOptions=function(a){this.options_=a};a.pkp.classes.features.Feature.prototype.getOptions=function(){return this.options_};a.pkp.classes.features.Feature.prototype.init=
...
function(a){a.children().after(this.getSequenceInput_());a=this.gridHandler.getRows();this.storeOrder(a)}})(jQuery);(function(a){a.pkp.classes.features.OrderMultipleListsItemsFeature=function(a,b){this.parent(a,b)};a.pkp.classes.Helper.inherits(a.pkp.classes.features.OrderMultipleListsItemsFeature,a.pkp.classes.features.OrderListbuilderItemsFeature);a.pkp.classes.features.OrderMultipleListsItemsFeature.prototype.addFeatureHtml=function(c,b){var d,e,f,h,j,i,m;this.parent("addFeatureHtml",c,b);d=a('<input type="hidden" name="newRowId[listId]" class="itemList" />');e=this.gridHandler.getRows();f=0;for(h=e.length;f<
h;f++)j=a(e[f]),i=this.gridHandler.getListIdByRow(j),m=d.clone(),m.attr("value",i),a("td.first_column",j).append(m)};a.pkp.classes.features.OrderMultipleListsItemsFeature.prototype.storeRowOrder=function(a,b){var d,e;this.parent("storeRowOrder",a,b);d=b.find(".itemList");e=this.gridHandler.getListIdByRow(b);d.attr("value",e)};a.pkp.classes.features.OrderMultipleListsItemsFeature.prototype.setupSortablePlugin=function(){var a=this.gridHandler.getLists().find("tbody");this.applySortPlgOnElements(a,
...
function(a,b){var d,e;d=this.getHtmlElement().find("th").length;e=a.first().find("td");e=b?e.attr("colspan"):e.length;return d==e};a.pkp.controllers.grid.GridHandler.prototype.replaceElementResponseHandler=function(c,b){var d,e,f,h,j,i,m;e=this.handleJson(b);if(!1!==e)if(e.elementNotFound)d=e.elementNotFound,d=this.getRowByDataId(d),0<d.length&&this.deleteElement(d);else{f=a(e.content);if(1<f.filter("tr:not('.row_controls')").length){d=f.filter("tr.gridRow");j=f.filter("tr.row_controls");i=0;for(m=
...
null),"json")):this.enableControls(),this.callFeaturesHook("addElement",d));return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.fetchOptionsResponseHandler_=function(c,b){var d=this.handleJson(b),e=this.getHtmlElement(),f=[],h,j,i,m,k,q,p,s,n,t;if(!1!==d){e.find(".gridCellDisplay :input").each(function(c,b){f[c]=a(b).val()});e=e.find(".gridRowEdit:visible .selectMenu:input");h=0;for(j=e.length;h<j;h++){i=a(e[h]);m=i.parents(".gridCellContainer");k=0;i.children().empty();q=null;for(q in d.content[h])if(q!=
...
"json"));d.attr("id").match(/approvedProofGrid/)&&this.trigger("dataChanged")};a.pkp.controllers.tab.catalogEntry.CatalogEntryTabHandler.prototype.updateTabsHandler_=function(a,b){var d=this.handleJson(b),e=this.getHtmlElement(),f=e.find("li a"),h={},j=/publication(\d+)/,i,m,k;for(m=0;m<f.length;m++)k=f[m].getAttribute("id"),k=j.exec(k),null!==k&&(h[k[1]]=m);for(i in d.formats)h.hasOwnProperty(i)||(f=this.tabContentUrl_+"&representationId="+encodeURIComponent(i),f=f.replace(/[$]/g,"$$$$"),e.tabs("add",
