...
this.gridHandler.getCategoryDataIdByRowId(b[e]);g=this.gridHandler.getCategoryIdPrefix()+g;-1<a.inArray(g,d)||d.push(g)}return d}})(jQuery);(function(a){a.pkp.classes.features.OrderListbuilderItemsFeature=function(b,a){this.parent(b,a)};a.pkp.classes.Helper.inherits(a.pkp.classes.features.OrderListbuilderItemsFeature,a.pkp.classes.features.OrderItemsFeature);a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.addFeatureHtml=function(b,c){var d;this.parent("addFeatureHtml",b,c);b=this.getSequenceInput_();c=this.gridHandler.getRows();var e=0;for(d=c.length;e<d;e++){var g=a(c[e]);var k=b.clone();a("td.first_column",g).append(k)}};
...
function(b,a){b+=1;a.find(".itemSequence").attr("value",b);a.find(".isModified").attr("value",1)};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.saveOrderHandler=function(){this.parent("saveOrderHandler");this.toggleState(!1);return!1};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.updateOrderCallback=function(b,a,d){this.parent("updateOrderCallback");b=this.gridHandler.getRows();this.storeOrder(b)};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.clickOrderHandler=
...
function(){this.$preview&&this.$preview.hide()};a.pkp.controllers.form.FileUploadFormHandler.prototype.attachUploader_=function(a,c){a.pkpHandler("$.pkp.controllers.UploaderHandler",c)}})(jQuery);(function(a){a.pkp.controllers.form.MultilingualInputHandler=function(a,c){this.parent(a,c);(a.hasClass("pkpTagit")?a.find(":input").filter(":visible"):a.find(":input").first()).focus(this.callbackWrapper(this.focusHandler_));a.find(":input").blur(this.callbackWrapper(this.blurHandler_));this.publishEvent("tinyMCEInitialized");this.tinyMCEInitHandler_();setTimeout(this.callbackWrapper(this.isIncomplete_),500)};a.pkp.classes.Helper.inherits(a.pkp.controllers.form.MultilingualInputHandler,a.pkp.classes.Handler);
...
function(a,c){a=this.getHtmlElement();0<parseInt(a.find("#revisedFileId").val(),10)&&(a.submit(),c.preventDefault())};a.pkp.controllers.wizard.fileUpload.form.RevisionConfirmationHandler.prototype.handleResponse=function(a,c){!0===c.status&&this.trigger("fileUploaded",c.uploadedFile);return this.parent("handleResponse",a,c)}})(jQuery);(function(a){a.pkp.controllers.grid.notifications=a.pkp.controllers.grid.notifications||{};a.pkp.controllers.grid.notifications.NotificationsGridHandler=function(a,c){a.find('a[id*="markNew"]').click(this.callbackWrapper(this.markNewHandler_));a.find('a[id*="markRead"]').click(this.callbackWrapper(this.markReadHandler_));a.find('a[id*="deleteNotification"]').click(this.callbackWrapper(this.deleteHandler_));this.parent(a,c)};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.notifications.NotificationsGridHandler,
...
c){a=this.getFetchExtraParams();a.selectedNotificationIds=c.content;this.setFetchExtraParams(a);this.handleJson(c)}})(jQuery);(function(a){a.pkp.controllers.grid.navigationMenus=a.pkp.controllers.grid.navigationMenus||{form:{}};a.pkp.controllers.grid.navigationMenus.form.NavigationMenuFormHandler=function(a,c){this.okButton_=c.okButton;this.warningModalTitle_=c.warningModalTitle;this.submenuWarning_=c.submenuWarning;this.itemTypeConditionalWarnings_=c.itemTypeConditionalWarnings;a.on("click",".btnConditionalDisplay",this.callbackWrapper(this.showConditionalDisplayWarning));a.on("click",".btnSubmenuWarning",this.callbackWrapper(this.showSubmenuWarning));
...
function(b){var c=a("[id^='recommendOnly']",this.getHtmlElement()),d,e=!1;for(d=0;d<this.recommendOnlyRoleIds_.length;d++)this.recommendOnlyRoleIds_[d]==b&&(e=!0);e?c.removeAttr("disabled"):(c.attr("disabled","disabled"),c.removeAttr("checked"))}})(jQuery);(function(a){a.pkp.controllers.tab=a.pkp.controllers.tab||{};a.pkp.controllers.tab.workflow=a.pkp.controllers.tab.workflow||{};a.pkp.controllers.tab.workflow.WorkflowTabHandler=function(a,c){var b,e;this.parent(a,c);if(b=document.location.toString().match("workflow/([^/]+)/")){b=b[1];var g=a.find("li a");for(e=0;e<g.length;e++)a=new RegExp(b),g[e].getAttribute("class").match(a)&&(c.selected=e)}};a.pkp.classes.Helper.inherits(a.pkp.controllers.tab.workflow.WorkflowTabHandler,a.pkp.controllers.TabHandler)})(jQuery);(function(a){a.pkp.controllers.dashboard=a.pkp.controllers.dashboard||{form:{}};a.pkp.controllers.dashboard.form.DashboardTaskFormHandler=function(b,c){this.parent(b,c);this.singleContextSubmissionUrl_=c.singleContextSubmissionUrl;a("#singleContext",b).click(this.callbackWrapper(this.startSingleContextSubmission_));a("#multipleContext",b).change(this.callbackWrapper(this.startMultipleContextSubmission_))};a.pkp.classes.Helper.inherits(a.pkp.controllers.dashboard.form.DashboardTaskFormHandler,a.pkp.controllers.form.FormHandler);
