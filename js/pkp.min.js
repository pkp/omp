...
function(b,c,d){var e=this.getHtmlElement();a.get(d.tabsUrl,function(a){e.prev("div").remove();e.replaceWith(a.content)})}})(jQuery);(function(a){a.pkp.controllers.catalog=a.pkp.controllers.catalog||{form:{}};a.pkp.controllers.catalog.form.CatalogMetadataFormHandler=function(b,c){this.parent(b,c);c.workTypeEditedVolume&&(this.workTypeEditedVolume_=c.workTypeEditedVolume);c.workTypeAuthoredWork&&(this.workTypeAuthoredWork_=c.workTypeAuthoredWork);a("#workType",b).change(this.callbackWrapper(this.toggleVolumeEditors));a("#audienceRangeExact",b).change(this.callbackWrapper(this.ensureValidAudienceRanges_));c.arePermissionsAttached&&
