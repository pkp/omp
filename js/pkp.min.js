...
w):m.addEventListener("load",w,!1);setTimeout(c,15);try{j.submit()}catch(z){document.createElement("form").submit.apply(j)}}finally{j.setAttribute("action",e),j.setAttribute("enctype",B),b?j.setAttribute("target",b):q.removeAttr("target"),a(h).remove()}}function w(c){if(!r.aborted&&!P)if(z=f(m),z||(d("cannot access response document"),c=I),c===O&&r)r.abort("timeout"),B.reject(r,"timeout");else if(c==I&&r)r.abort("server abort"),B.reject(r,"error","server abort");else if(z&&z.location.href!=l.iframeSrc||
E){m.detachEvent?m.detachEvent("onload",w):m.removeEventListener("load",w,!1);var c="success",b;try{if(E)throw"timeout";var e="xml"==l.dataType||z.XMLDocument||a.isXMLDoc(z);d("isXml="+e);if(!e&&(window.opera&&(null===z.body||!z.body.innerHTML))&&--T){d("requeing onLoad callback, DOM not available");setTimeout(w,250);return}var g=z.body?z.body:z.documentElement;r.responseText=g?g.innerHTML:null;r.responseXML=z.XMLDocument?z.XMLDocument:z;e&&(l.dataType="xml");r.getResponseHeader=function(a){return{"content-type":l.dataType}[a.toLowerCase()]};
...
a.globalEval(x));C=x}catch(s){c="parsererror",r.error=b=s||c}}catch(u){d("error caught: ",u),c="error",r.error=b=u||c}r.aborted&&(d("upload aborted"),c=null);r.status&&(c=200<=r.status&&300>r.status||304===r.status?"success":"error");"success"===c?(l.success&&l.success.call(l.context,C,"success",r),B.resolve(r.responseText,"success",r),k&&a.event.trigger("ajaxSuccess",[r,l])):c&&(void 0===b&&(b=r.statusText),l.error&&l.error.call(l.context,r,c,b),B.reject(r,"error",b),k&&a.event.trigger("ajaxError",
[r,l,b]));k&&a.event.trigger("ajaxComplete",[r,l]);k&&!--a.active&&a.event.trigger("ajaxStop");l.complete&&l.complete.call(l.context,r,c);P=!0;l.timeout&&clearTimeout(G);setTimeout(function(){l.iframeTarget?p.attr("src",l.iframeSrc):p.remove();r.responseXML=null},100)}}var j=q[0],v,l,k,y,p,m,r,E,G,B=a.Deferred();B.abort=function(a){r.abort(a)};if(e)for(v=0;v<s.length;v++)e=a(s[v]),h?e.prop("disabled",!1):e.removeAttr("disabled");l=a.extend(!0,{},a.ajaxSettings,c);l.context=l.context||l;y="jqFormIO"+
...
m.contentWindow.document.execCommand("Stop")}catch(e){}p.attr("src",l.iframeSrc);r.error=b;l.error&&l.error.call(l.context,r,b,c);k&&a.event.trigger("ajaxError",[r,l,b]);l.complete&&l.complete.call(l.context,r,b)}};(k=l.global)&&0===a.active++&&a.event.trigger("ajaxStart");k&&a.event.trigger("ajaxSend",[r,l]);if(l.beforeSend&&!1===l.beforeSend.call(l.context,r,l))return l.global&&a.active--,B.reject(),B;if(r.aborted)return B.reject(),B;if(e=j.clk)if((v=e.name)&&!e.disabled)l.extraData=l.extraData||
{},l.extraData[v]=e.value,"image"==e.type&&(l.extraData[v+".x"]=j.clk_x,l.extraData[v+".y"]=j.clk_y);var O=1,I=2,e=a("meta[name=csrf-token]").attr("content");if((v=a("meta[name=csrf-param]").attr("content"))&&e)l.extraData=l.extraData||{},l.extraData[v]=e;l.forceSync?g():setTimeout(g,10);var C,z,T=50,P,t=a.parseXML||function(a,c){window.ActiveXObject?(c=new ActiveXObject("Microsoft.XMLDOM"),c.async="false",c.loadXML(a)):c=(new DOMParser).parseFromString(a,"text/xml");return c&&c.documentElement&&
"parsererror"!=c.documentElement.nodeName?c:null},A=a.parseJSON||function(a){return window.eval("("+a+")")};return B}if(!this.length)return d("ajaxSubmit: skipping submit process - no element selected"),this;var n,k,q=this;"function"==typeof c?c={success:c}:void 0===c&&(c={});n=c.type||this.attr2("method");k=c.url||this.attr2("action");(k=(k="string"===typeof k?a.trim(k):"")||window.location.href||"")&&(k=(k.match(/^([^#]+)/)||[])[1]);c=a.extend(!0,{url:k,success:a.ajaxSettings.success,type:n||a.ajaxSettings.type,
iframeSrc:/^https/i.test(window.location.href||"")?"javascript:false":"about:blank"},c);k={};this.trigger("form-pre-serialize",[this,c,k]);if(k.veto)return d("ajaxSubmit: submit vetoed via form-pre-serialize trigger"),this;if(c.beforeSerialize&&!1===c.beforeSerialize(this,c))return d("ajaxSubmit: submit aborted via beforeSerialize callback"),this;var p=c.traditional;void 0===p&&(p=a.ajaxSettings.traditional);var s=[],m,t=this.formToArray(c.semantic,s);c.data&&(c.extraData=c.data,m=a.param(c.data,
p));if(c.beforeSubmit&&!1===c.beforeSubmit(t,this,c))return d("ajaxSubmit: submit aborted via beforeSubmit callback"),this;this.trigger("form-submit-validate",[t,this,c,k]);if(k.veto)return d("ajaxSubmit: submit vetoed via form-submit-validate trigger"),this;k=a.param(t,p);m&&(k=k?k+"&"+m:m);"GET"==c.type.toUpperCase()?(c.url+=(0<=c.url.indexOf("?")?"&":"?")+k,c.data=null):c.data=k;var u=[];c.resetForm&&u.push(function(){q.resetForm()});c.clearForm&&u.push(function(){q.clearForm(c.includeHidden)});
if(!c.dataType&&c.target){var g=c.success||function(){};u.push(function(b){var d=c.replaceTarget?"replaceWith":"html";a(c.target)[d](b).each(g,arguments)})}else c.success&&u.push(c.success);c.success=function(a,b,d){for(var e=c.context||this,f=0,g=u.length;f<g;f++)u[f].apply(e,[a,b,d||q,q])};if(c.error){var D=c.error;c.error=function(a,b,d){D.apply(c.context||this,[a,b,d,q])}}if(c.complete){var w=c.complete;c.complete=function(a,b){w.apply(c.context||this,[a,b,q])}}m=0<a("input[type=file]:enabled",
this).filter(function(){return""!==a(this).val()}).length;k="multipart/form-data"==q.attr("enctype")||"multipart/form-data"==q.attr("encoding");p=e&&f;d("fileAPI :"+p);var v;if(!1!==c.iframe&&(c.iframe||(m||k)&&!p))c.closeKeepAlive?a.get(c.closeKeepAlive,function(){v=b(t)}):v=b(t);else if((m||k)&&p){var l=new FormData;for(k=0;k<t.length;k++)l.append(t[k].name,t[k].value);if(c.extraData){k=a.param(c.extraData,c.traditional).split("&");p=k.length;m=[];var y,E;for(y=0;y<p;y++)k[y]=k[y].replace(/\+/g,
" "),E=k[y].split("="),m.push([decodeURIComponent(E[0]),decodeURIComponent(E[1])]);for(k=0;k<m.length;k++)m[k]&&l.append(m[k][0],m[k][1])}c.data=null;m=a.extend(!0,{},a.ajaxSettings,c,{contentType:!1,processData:!1,cache:!1,type:n||"POST"});c.uploadProgress&&(m.xhr=function(){var b=a.ajaxSettings.xhr();b.upload&&b.upload.addEventListener("progress",function(a){var b=0,d=a.loaded||a.position,e=a.total;a.lengthComputable&&(b=Math.ceil(100*(d/e)));c.uploadProgress(a,d,e,b)},!1);return b});m.data=null;
var A=m.beforeSend;m.beforeSend=function(a,b){b.data=c.formData?c.formData:l;A&&A.call(this,a,b)};v=a.ajax(m)}else v=a.ajax(c);q.removeData("jqxhr").data("jqxhr",v);for(m=0;m<s.length;m++)s[m]=null;this.trigger("form-submit-notify",[this,c]);return this};a.fn.ajaxForm=function(e){e=e||{};e.delegation=e.delegation&&a.isFunction(a.fn.on);if(!e.delegation&&0===this.length){var f=this.selector,h=this.context;if(!a.isReady&&f)return d("DOM not ready, queuing ajaxForm"),a(function(){a(f,h).ajaxForm(e)}),
...
b){var d=[];if(0===this.length)return d;var f=this[0],h=this.attr("id"),p=c?f.getElementsByTagName("*"):f.elements;p&&!/MSIE [678]/.test(navigator.userAgent)&&(p=a(p).get());h&&(h=a(':input[form="'+h+'"]').get(),h.length&&(p=(p||[]).concat(h)));if(!p||!p.length)return d;var s,m,t,u,g;s=0;for(g=p.length;s<g;s++)if(u=p[s],(h=u.name)&&!u.disabled)if(c&&f.clk&&"image"==u.type)f.clk==u&&(d.push({name:h,value:a(u).val(),type:u.type}),d.push({name:h+".x",value:f.clk_x},{name:h+".y",value:f.clk_y}));else if((t=
a.fieldValue(u,!0))&&t.constructor==Array){b&&b.push(u);m=0;for(u=t.length;m<u;m++)d.push({name:h,value:t[m]})}else if(e&&"file"==u.type)if(b&&b.push(u),t=u.files,t.length)for(m=0;m<t.length;m++)d.push({name:h,value:t[m],type:u.type});else d.push({name:h,value:"",type:u.type});else null!==t&&"undefined"!=typeof t&&(b&&b.push(u),d.push({name:h,value:t,type:u.type,required:u.required}));if(!c&&f.clk&&(p=a(f.clk),s=p[0],(h=s.name)&&!s.disabled&&"image"==s.type))d.push({name:h,value:p.val()}),d.push({name:h+
...
b.screenY===d.data("selectBox-down-at-y")||(d.removeData("selectBox-down-at-x").removeData("selectBox-down-at-y"),p(c,a(this).parent()),q())}).bind("mouseover.selectBox",function(){s(c,a(this).parent())}).bind("mouseout.selectBox",function(){m(c,a(this).parent())});var f=c.attr("class")||"";if(""!==f){var f=f.split(" "),g;for(g in f)d.addClass(f[g]+"-selectBox-dropdown-menu")}D(d);return d}},i=function(c){return("selectBox-label "+(a(c).find("OPTION:selected").attr("class")||"")).replace(/\s+$/,"")},
j=function(c){return a(c).find("OPTION:selected").text()||"\u00a0"},n=function(c){var c=a(c),b=c.data("selectBox-control");b&&b.find(".selectBox-label").attr("class",i(c)).text(j(c))},k=function(c){var c=a(c),b=c.data("selectBox-control"),d=c.data("selectBox-settings"),e=b.data("selectBox-options");if(b.hasClass("selectBox-disabled"))return!1;q();var f=isNaN(b.css("borderBottomWidth"))?0:parseInt(b.css("borderBottomWidth"));e.width(b.innerWidth()).css({top:b.offset().top+b.outerHeight()-f,left:b.offset().left});
...
function(a){u(b,a)}).bind("keypress.selectBox",function(a){g(b,a)}).bind("mousedown.selectBox",function(c){a(c.target).is("A.selectBox-inline")&&c.preventDefault();e.hasClass("selectBox-focus")||e.focus()}).insertAfter(b),!b[0].style.height){var f=b.attr("size")?parseInt(b.attr("size")):5,n=e.clone().removeAttr("id").css({position:"absolute",top:"-9999em"}).show().appendTo("body");n.find(".selectBox-options").html("<li><a>\u00a0</a></li>");var p=parseInt(n.find(".selectBox-options A:first").html("&nbsp;").outerHeight());
n.remove();e.height(p*f)}}else f=a('<span class="selectBox-label" />'),n=a('<span class="selectBox-arrow" />'),f.attr("class",i(b)).text(j(b)),d=h(b,"dropdown"),d.appendTo("BODY"),e.data("selectBox-options",d).addClass("selectBox-dropdown").append(f).append(n).bind("mousedown.selectBox",function(a){e.hasClass("selectBox-menuShowing")?q():(a.stopPropagation(),d.data("selectBox-down-at-x",a.screenX).data("selectBox-down-at-y",a.screenY),k(b))}).bind("keydown.selectBox",function(a){u(b,a)}).bind("keypress.selectBox",
function(a){g(b,a)}).bind("open.selectBox",function(a,c){c&&!0===c._selectBox||k(b)}).bind("close.selectBox",function(a,c){c&&!0===c._selectBox||q()}).insertAfter(b),n=e.width()-n.outerWidth()-parseInt(f.css("paddingLeft"))-parseInt(f.css("paddingLeft")),f.width(n);D(e);b.addClass("selectBox").data("selectBox-control",e).data("selectBox-settings",m).hide()}})}return a(this)}})}(jQuery);(function(){function a(a){return function(c,b,d,e){var b=D(b,e,4),f=!x(c)&&g.keys(c),h=(f||c).length,i=0<a?0:h-1;3>arguments.length&&(d=c[f?f[i]:i],i+=a);for(var j=b,k=d;0<=i&&i<h;i+=a)var l=f?f[i]:i,k=j(k,c[l],l,c);return k}}function c(a){return function(c,b,d){for(var b=w(b,d),d=A(c),e=0<a?0:d-1;0<=e&&e<d;e+=a)if(b(c[e],e,c))return e;return-1}}function b(a,c,b){return function(d,e,f){var h=0,i=A(d);if("number"==typeof f)0<a?h=0<=f?f:Math.max(f+i,h):i=0<=f?Math.min(f+1,i):f+i+1;else if(b&&f&&i)return f=
b(d,e),d[f]===e?f:-1;if(e!==e)return f=c(n.call(d,h,i),g.isNaN),0<=f?f+h:-1;for(f=0<a?h:i-1;0<=f&&f<i;f+=a)if(d[f]===e)return f;return-1}}function d(a,c){var b=Q.length,d=a.constructor,d=g.isFunction(d)&&d.prototype||i,e="constructor";for(g.has(a,e)&&!g.contains(c,e)&&c.push(e);b--;)e=Q[b],e in a&&(a[e]!==d[e]&&!g.contains(c,e))&&c.push(e)}var e=this,f=e._,h=Array.prototype,i=Object.prototype,j=h.push,n=h.slice,k=i.toString,q=i.hasOwnProperty,p=Array.isArray,s=Object.keys,m=Function.prototype.bind,
...
d,e,f){return a.call(c,b,d,e,f)}}return function(){return a.apply(c,arguments)}},w=function(a,c,b){return null==a?g.identity:g.isFunction(a)?D(a,c,b):g.isObject(a)?g.matcher(a):g.property(a)};g.iteratee=function(a,c){return w(a,c,Infinity)};var v=function(a,c){return function(b){var d=arguments.length;if(2>d||null==b)return b;for(var e=1;e<d;e++)for(var f=arguments[e],g=a(f),h=g.length,i=0;i<h;i++){var j=g[i];if(!c||void 0===b[j])b[j]=f[j]}return b}},l=function(a){if(!g.isObject(a))return{};if(t)return t(a);
u.prototype=a;a=new u;u.prototype=null;return a},y=function(a){return function(c){return null==c?void 0:c[a]}},E=Math.pow(2,53)-1,A=y("length"),x=function(a){a=A(a);return"number"==typeof a&&0<=a&&a<=E};g.each=g.forEach=function(a,c,b){var c=D(c,b),d;if(x(a)){b=0;for(d=a.length;b<d;b++)c(a[b],b,a)}else{var e=g.keys(a),b=0;for(d=e.length;b<d;b++)c(a[e[b]],e[b],a)}return a};g.map=g.collect=function(a,c,b){for(var c=w(c,b),b=!x(a)&&g.keys(a),d=(b||a).length,e=Array(d),f=0;f<d;f++){var h=b?b[f]:f;e[f]=
c(a[h],h,a)}return e};g.reduce=g.foldl=g.inject=a(1);g.reduceRight=g.foldr=a(-1);g.find=g.detect=function(a,c,b){c=x(a)?g.findIndex(a,c,b):g.findKey(a,c,b);if(void 0!==c&&-1!==c)return a[c]};g.filter=g.select=function(a,c,b){var d=[],c=w(c,b);g.each(a,function(a,b,e){c(a,b,e)&&d.push(a)});return d};g.reject=function(a,c,b){return g.filter(a,g.negate(w(c)),b)};g.every=g.all=function(a,c,b){for(var c=w(c,b),b=!x(a)&&g.keys(a),d=(b||a).length,e=0;e<d;e++){var f=b?b[e]:e;if(!c(a[f],f,a))return!1}return!0};
g.some=g.any=function(a,c,b){for(var c=w(c,b),b=!x(a)&&g.keys(a),d=(b||a).length,e=0;e<d;e++){var f=b?b[e]:e;if(c(a[f],f,a))return!0}return!1};g.contains=g.includes=g.include=function(a,c,b,d){x(a)||(a=g.values(a));if("number"!=typeof b||d)b=0;return 0<=g.indexOf(a,c,b)};g.invoke=function(a,c){var b=n.call(arguments,2),d=g.isFunction(c);return g.map(a,function(a){var e=d?c:a[c];return null==e?e:e.apply(a,b)})};g.pluck=function(a,c){return g.map(a,g.property(c))};g.where=function(a,c){return g.filter(a,
g.matcher(c))};g.findWhere=function(a,c){return g.find(a,g.matcher(c))};g.max=function(a,c,b){var d=-Infinity,e=-Infinity,f;if(null==c&&null!=a)for(var a=x(a)?a:g.values(a),h=0,i=a.length;h<i;h++)b=a[h],b>d&&(d=b);else c=w(c,b),g.each(a,function(a,b,g){f=c(a,b,g);if(f>e||-Infinity===f&&-Infinity===d)d=a,e=f});return d};g.min=function(a,c,b){var d=Infinity,e=Infinity,f;if(null==c&&null!=a)for(var a=x(a)?a:g.values(a),h=0,i=a.length;h<i;h++)b=a[h],b<d&&(d=b);else c=w(c,b),g.each(a,function(a,b,g){f=
c(a,b,g);if(f<e||Infinity===f&&Infinity===d)d=a,e=f});return d};g.shuffle=function(a){for(var a=x(a)?a:g.values(a),c=a.length,b=Array(c),d=0,e;d<c;d++)e=g.random(0,d),e!==d&&(b[d]=b[e]),b[e]=a[d];return b};g.sample=function(a,c,b){return null==c||b?(x(a)||(a=g.values(a)),a[g.random(a.length-1)]):g.shuffle(a).slice(0,Math.max(0,c))};g.sortBy=function(a,c,b){c=w(c,b);return g.pluck(g.map(a,function(a,b,d){return{value:a,index:b,criteria:c(a,b,d)}}).sort(function(a,c){var b=a.criteria,d=c.criteria;if(b!==
d){if(b>d||void 0===b)return 1;if(b<d||void 0===d)return-1}return a.index-c.index}),"value")};var H=function(a){return function(c,b,d){var e={},b=w(b,d);g.each(c,function(d,f){var g=b(d,f,c);a(e,d,g)});return e}};g.groupBy=H(function(a,c,b){g.has(a,b)?a[b].push(c):a[b]=[c]});g.indexBy=H(function(a,c,b){a[b]=c});g.countBy=H(function(a,c,b){g.has(a,b)?a[b]++:a[b]=1});g.toArray=function(a){return!a?[]:g.isArray(a)?n.call(a):x(a)?g.map(a,g.identity):g.values(a)};g.size=function(a){return null==a?0:x(a)?
a.length:g.keys(a).length};g.partition=function(a,c,b){var c=w(c,b),d=[],e=[];g.each(a,function(a,b,f){(c(a,b,f)?d:e).push(a)});return[d,e]};g.first=g.head=g.take=function(a,c,b){return null==a?void 0:null==c||b?a[0]:g.initial(a,a.length-c)};g.initial=function(a,c,b){return n.call(a,0,Math.max(0,a.length-(null==c||b?1:c)))};g.last=function(a,c,b){return null==a?void 0:null==c||b?a[a.length-1]:g.rest(a,Math.max(0,a.length-c))};g.rest=g.tail=g.drop=function(a,c,b){return n.call(a,null==c||b?1:c)};g.compact=
function(a){return g.filter(a,g.identity)};var F=function(a,c,b,d){for(var e=[],f=0,d=d||0,h=A(a);d<h;d++){var i=a[d];if(x(i)&&(g.isArray(i)||g.isArguments(i))){c||(i=F(i,c,b));var j=0,k=i.length;for(e.length+=k;j<k;)e[f++]=i[j++]}else b||(e[f++]=i)}return e};g.flatten=function(a,c){return F(a,c,!1)};g.without=function(a){return g.difference(a,n.call(arguments,1))};g.uniq=g.unique=function(a,c,b,d){g.isBoolean(c)||(d=b,b=c,c=!1);null!=b&&(b=w(b,d));for(var d=[],e=[],f=0,h=A(a);f<h;f++){var i=a[f],
...
{};return b};g.delay=function(a,c){var b=n.call(arguments,2);return setTimeout(function(){return a.apply(null,b)},c)};g.defer=g.partial(g.delay,g,1);g.throttle=function(a,c,b){var d,e,f,h=null,i=0;b||(b={});var j=function(){i=!1===b.leading?0:g.now();h=null;f=a.apply(d,e);h||(d=e=null)};return function(){var k=g.now();!i&&!1===b.leading&&(i=k);var l=c-(k-i);d=this;e=arguments;0>=l||l>c?(h&&(clearTimeout(h),h=null),i=k,f=a.apply(d,e),h||(d=e=null)):!h&&!1!==b.trailing&&(h=setTimeout(j,l));return f}};
...
return c};g.allKeys=function(a){if(!g.isObject(a))return[];var c=[],b;for(b in a)c.push(b);N&&d(a,c);return c};g.values=function(a){for(var c=g.keys(a),b=c.length,d=Array(b),e=0;e<b;e++)d[e]=a[c[e]];return d};g.mapObject=function(a,c,b){for(var c=w(c,b),b=g.keys(a),d=b.length,e={},f,h=0;h<d;h++)f=b[h],e[f]=c(a[f],f,a);return e};g.pairs=function(a){for(var c=g.keys(a),b=c.length,d=Array(b),e=0;e<b;e++)d[e]=[c[e],a[c[e]]];return d};g.invert=function(a){for(var c={},b=g.keys(a),d=0,e=b.length;d<e;d++)c[a[b[d]]]=
b[d];return c};g.functions=g.methods=function(a){var c=[],b;for(b in a)g.isFunction(a[b])&&c.push(b);return c.sort()};g.extend=v(g.allKeys);g.extendOwn=g.assign=v(g.keys);g.findKey=function(a,c,b){for(var c=w(c,b),b=g.keys(a),d,e=0,f=b.length;e<f;e++)if(d=b[e],c(a[d],d,a))return d};g.pick=function(a,c,b){var d={},e=a,f,h;if(null==e)return d;g.isFunction(c)?(h=g.allKeys(e),f=D(c,b)):(h=F(arguments,!1,!1,1),f=function(a,c,b){return c in b},e=Object(e));for(var i=0,j=h.length;i<j;i++){var k=h[i],l=e[k];
f(l,k,e)&&(d[k]=l)}return d};g.omit=function(a,c,b){if(g.isFunction(c))c=g.negate(c);else var d=g.map(F(arguments,!1,!1,1),String),c=function(a,c){return!g.contains(d,c)};return g.pick(a,c,b)};g.defaults=v(g.allKeys,!0);g.create=function(a,c){var b=l(a);c&&g.extendOwn(b,c);return b};g.clone=function(a){return!g.isObject(a)?a:g.isArray(a)?a.slice():g.extend({},a)};g.tap=function(a,c){c(a);return a};g.isMatch=function(a,c){var b=g.keys(c),d=b.length;if(null==a)return!d;for(var e=Object(a),f=0;f<d;f++){var h=
...
q.call(a,c)};g.noConflict=function(){e._=f;return this};g.identity=function(a){return a};g.constant=function(a){return function(){return a}};g.noop=function(){};g.property=y;g.propertyOf=function(a){return null==a?function(){}:function(c){return a[c]}};g.matcher=g.matches=function(a){a=g.extendOwn({},a);return function(c){return g.isMatch(c,a)}};g.times=function(a,c,b){for(var d=Array(Math.max(0,a)),c=D(c,b,1),b=0;b<a;b++)d[b]=c(b);return d};g.random=function(a,c){null==c&&(c=a,a=0);return a+Math.floor(Math.random()*
(c-a+1))};g.now=Date.now||function(){return(new Date).getTime()};p={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;"};v=g.invert(p);y=function(a){var c=function(c){return a[c]},b="(?:"+g.keys(a).join("|")+")",d=RegExp(b),e=RegExp(b,"g");return function(a){a=null==a?"":""+a;return d.test(a)?a.replace(e,c):a}};g.escape=y(p);g.unescape=y(v);g.result=function(a,c,b){c=null==a?void 0:a[c];void 0===c&&(c=b);return g.isFunction(c)?c.call(a):c};var U=0;g.uniqueId=function(a){var c=
...
"){\n"+e+"}";return b};g.chain=function(a){a=g(a);a._chain=!0;return a};var L=function(a,c){return a._chain?g(c).chain():c};g.mixin=function(a){g.each(g.functions(a),function(c){var b=g[c]=a[c];g.prototype[c]=function(){var a=[this._wrapped];j.apply(a,arguments);return L(this,b.apply(g,a))}})};g.mixin(g);g.each("pop push reverse shift sort splice unshift".split(" "),function(a){var c=h[a];g.prototype[a]=function(){var b=this._wrapped;c.apply(b,arguments);("shift"===a||"splice"===a)&&0===b.length&&
...
this.$linkActionElement.focus();this.$modal_.remove();return this.parent("finish")}})(jQuery);(function(a){a.pkp.classes.notification=a.pkp.classes.notification||{};a.pkp.classes.notification.NotificationHelper=function(){};a.pkp.classes.notification.NotificationHelper.redirectNotifyUserEvent=function(c,b){var d,e,f,h,i,j,n,k,q,p,s;if(void 0!==b.content)c.getHtmlElement().parent().trigger("notifyUser",[b]);else{d=c.getHtmlElement();e=!1;!(c instanceof a.pkp.controllers.SiteHandler)&&0<a(b).parents(".pkp_controllers_grid").length&&(d.parent().trigger("notifyUser"),e=!0);d=a(".pkp_notification",
d);f=[];h=0;for(i=d.length;h<i;h++)if(n=a(d[h]),!(0<n.parents(":hidden").length)){j=n.parents();q=0;for(p=j.length;q<p;q++)if(k=a(j[q]).data("pkp.handler"),k instanceof a.pkp.classes.Handler){s=a(j[q]);break}if(s.has(b[0]).length||s[0]===b[0]){if(0<n.parents(".ui-accordion:first").length&&(j=n.parents(".ui-accordion:first"),!j.has(b[0])))continue;f.push(n)}}if(f.length)for(h=f.length-1;-1<h;h--)f[h].triggerHandler("notifyUser");else e||c.getHtmlElement().parent().trigger("notifyUser")}}})(jQuery);(function(a){a.pkp.classes.features=a.pkp.classes.features||{};a.pkp.classes.features.Feature=function(a,b){this.gridHandler=a;this.options_=b;this.addFeatureHtml(this.getGridHtmlElement(),b)};a.pkp.classes.features.Feature.prototype.gridHandler=null;a.pkp.classes.features.Feature.prototype.options_=null;a.pkp.classes.features.Feature.prototype.setOptions=function(a){this.options_=a};a.pkp.classes.features.Feature.prototype.getOptions=function(){return this.options_};a.pkp.classes.features.Feature.prototype.init=
...
function(a){a.children().after(this.getSequenceInput_());a=this.gridHandler.getRows();this.storeOrder(a)}})(jQuery);(function(a){a.pkp.classes.features.GeneralPagingFeature=function(a,b){b.defaultItemsPerPage=parseInt(b.defaultItemsPerPage,10);b.currentItemsPerPage=parseInt(b.currentItemsPerPage,10);b.itemsTotal=b.itemsTotal?parseInt(b.itemsTotal,10):0;b.currentPage=parseInt(b.currentPage,10);this.parent(a,b)};a.pkp.classes.Helper.inherits(a.pkp.classes.features.GeneralPagingFeature,a.pkp.classes.features.Feature);a.pkp.classes.features.GeneralPagingFeature.prototype.getOptions=function(){return this.parent("getOptions")};
...
function(a,b){var d,e;d=this.getHtmlElement().find("th").length;e=a.first().find("td");e=b?e.attr("colspan"):e.length;return d==e};a.pkp.controllers.grid.GridHandler.prototype.replaceElementResponseHandler=function(c,b){var d,e,f,h,i,j,n;e=this.handleJson(b);if(!1!==e)if(e.elementNotFound)d=e.elementNotFound,d=this.getRowByDataId(d),0<d.length&&this.deleteElement(d);else{f=a(e.content);if(1<f.filter("tr:not('.row_controls')").length){d=f.filter("tr.gridRow");i=f.filter("tr.row_controls");j=0;for(n=
...
null),"json")):this.enableControls(),this.callFeaturesHook("addElement",d));return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.fetchOptionsResponseHandler_=function(c,b){var d=this.handleJson(b),e=this.getHtmlElement(),f=[],h,i,j,n,k,q,p,s,m,t;if(!1!==d){e.find(".gridCellDisplay :input").each(function(c,b){f[c]=a(b).val()});e=e.find(".gridRowEdit:visible .selectMenu:input");h=0;for(i=e.length;h<i;h++){j=a(e[h]);n=j.parents(".gridCellContainer");k=0;j.children().empty();q=null;for(q in d.content[h])if(q!=
...
300);c.trigger("pkpModalOpen",[c])};a.pkp.controllers.modal.ModalHandler.prototype.modalClose=function(){var a=this,b=this.getHtmlElement(),d=b.find("form").first(),e;if(1==d.length&&(e={closePermitted:!0},d.trigger("containerClose",[e]),!e.closePermitted))return!1;b.removeClass("is_visible");this.trigger("pkpModalClose");setTimeout(function(){var d=a.options.closeCleanVueInstances,e,i;if(d.length)for(i=0;i<d.length;i++)e=d[i],"undefined"!==typeof pkp.registry._instances[e]&&(e=pkp.registry._instances[e],
...
function(a,b){var d=this.getHtmlElement();0<parseInt(d.find("#revisedFileId").val(),10)&&(d.submit(),b.preventDefault())};a.pkp.controllers.wizard.fileUpload.form.RevisionConfirmationHandler.prototype.handleResponse=function(a,b){!0===b.status&&this.trigger("fileUploaded",b.uploadedFile);return this.parent("handleResponse",a,b)}})(jQuery);(function(a){a.pkp.controllers.grid.notifications=a.pkp.controllers.grid.notifications||{};a.pkp.controllers.grid.notifications.NotificationsGridHandler=function(a,b){a.find('a[id*="markNew"]').mousedown(this.callbackWrapper(this.markNewHandler_));a.find('a[id*="markRead"]').mousedown(this.callbackWrapper(this.markReadHandler_));a.find('a[id*="deleteNotifications"]').mousedown(this.callbackWrapper(this.deleteHandler_));this.parent(a,b)};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.notifications.NotificationsGridHandler,
...
e.filter('input[value="'+c+'"]').parent().addClass("optionalColumn")}})(jQuery);jQuery.pkp.pages.submission=jQuery.pkp.pages.submission||{};
...
"json"));d.attr("id").match(/approvedProofGrid/)&&this.trigger("dataChanged")};a.pkp.controllers.tab.catalogEntry.CatalogEntryTabHandler.prototype.updateTabsHandler_=function(a,b){var d=this.handleJson(b),e=this.getHtmlElement(),f=e.find("li a"),h={},i=/publication(\d+)/,j,n,k;for(n=0;n<f.length;n++)k=f[n].getAttribute("id"),k=i.exec(k),null!==k&&(h[k[1]]=n);for(j in d.formats)h.hasOwnProperty(j)||(f=this.tabContentUrl_+"&representationId="+encodeURIComponent(j),f=f.replace(/[$]/g,"$$$$"),e.tabs("add",
f,d.formats[j]),e.find("li a").filter(":last").attr("id","publication"+j));for(j in h)d.formats.hasOwnProperty(j)?e.find("li a").filter('[id="publication'+j+'"]').html(d.formats[j]):e.tabs("remove",h[j])};a.pkp.controllers.tab.catalogEntry.CatalogEntryTabHandler.prototype.addFormatsGridRowActionHandlers_=function(){var c=a('[id^="formatsGridContainer"]',this.getHtmlElement());c.length&&(c=a('a[id*="publicationFormatTab"]',c),c.click(this.callbackWrapper(this.formatsGridLinkClickHandler_)))};a.pkp.controllers.tab.catalogEntry.CatalogEntryTabHandler.prototype.formatsGridLinkClickHandler_=
