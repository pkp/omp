...
function(){clearTimeout(this.resize_check);this.resize_check=setTimeout(this.callbackWrapper(this.setDropdownAlignment),1E3)}})(jQuery);(function(a){a.pkp.controllers.UploaderHandler=function(c,b){this.parent(c,b);if(!c.is("div"))throw Error("An uploader widget controller can only be attached to a div!");var d=a.extend({},this.self("DEFAULT_PROPERTIES_"),{url:b.uploadUrl,flash_swf_url:b.baseUrl+"/lib/pkp/lib/vendor/moxiecode/plupload/js/Moxie.swf",silverlight_xap_url:b.baseUrl+"/lib/pkp/lib/vendor/moxiecode/plupload/js/Moxie.xap"});c.plupload(d);d=c.plupload("getUploader");d.refresh();/Firefox[\/\s](\d+\.\d+)/.test(navigator.userAgent)||
c.find("div.plupload").css("z-index",99999);c.find("div.plupload input").css("z-index",99999);d.bind("FilesAdded",this.callbackWrapper(this.limitQueueSize));d.bind("QueueChanged",this.callbackWrapper(this.refreshUploader))};a.pkp.classes.Helper.inherits(a.pkp.controllers.UploaderHandler,a.pkp.classes.Handler);a.pkp.controllers.UploaderHandler.prototype.limitQueueSize=function(a,b){1<b.files.length&&(b.splice(0,1),b.refresh())};a.pkp.controllers.UploaderHandler.prototype.refreshUploader=function(a,
b){b.refresh()};a.pkp.controllers.UploaderHandler.DEFAULT_PROPERTIES_={runtimes:"html5,flash,silverlight,html4",max_file_size:a.pkp.cons.UPLOAD_MAX_FILESIZE,multi_selection:!1,file_data_name:"uploadedFile",multipart:!0,headers:{browser_user_agent:navigator.userAgent}}})(jQuery);(function(a){a.pkp.controllers.AutocompleteHandler=function(c,b){var d;this.parent(c,b);this.sourceUrl_=b.sourceUrl;b.sourceUrl=void 0;this.jLabelText_=b.jLabelText;this.disableSync_=b.disableSync;d={};d.source=this.callbackWrapper(this.fetchAutocomplete);d.appendTo="#"+c.attr("id");d=a.extend({},this.self("DEFAULT_PROPERTIES_"),d,b);this.textInput=c.find(":text");this.disableSync_||this.textInput.keyup(this.callbackWrapper(this.synchronizeFields_));this.textInput.autocomplete(d);this.textInput.attr("title",
...
c.isDefaultPrevented()||this.advanceOrClose_();return!1};a.pkp.controllers.wizard.WizardHandler.prototype.formValid=function(){this.getContinueButton().button("enable")};a.pkp.controllers.wizard.WizardHandler.prototype.formInvalid=function(){this.getContinueButton().button("disable")};a.pkp.controllers.wizard.WizardHandler.prototype.formSubmitted=function(){this.advanceOrClose_()};a.pkp.controllers.wizard.WizardHandler.prototype.cancelRequest=function(){this.checkForm_(!1);var c=new a.Event("wizardCancelRequested");
this.getCurrentTab().children().first().trigger(c);c.isDefaultPrevented()||this.trigger("wizardCancel");return!1};a.pkp.controllers.wizard.WizardHandler.prototype.wizardCancelRequested=function(){return this.checkForm_(!0)?!1:!0};a.pkp.controllers.wizard.WizardHandler.prototype.wizardAdvanceRequested=function(a,b){var d=this.getForm_();d&&(d.submit()&&(this.getContinueButton().button("disable"),this.getProgressIndicator().show()),b.preventDefault())};a.pkp.controllers.wizard.WizardHandler.prototype.wizardAdvance=
...
"";a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.metadataUrl_="";a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.finishUrl_="";a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.uploadedFile_=null;a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.tabsBeforeActivate=function(a,b,d){if(0<d.newTab.index()){if(!this.uploadedFile_)throw Error("Uploaded file missing!");this.getHtmlElement();var e="";switch(d.newTab.index()){case 1:e=
this.metadataUrl_;break;case 2:e=this.finishUrl_;break;default:throw Error("Unsupported tab index.");}e=e+"&fileId="+this.uploadedFile_.fileId;d.newTab.find(".ui-tabs-anchor").attr("href",e)}return this.parent("tabsBeforeActivate",a,b,d)};a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.wizardAdvance=function(){var a=this.getCurrentStep(),b=this.getNumberOfSteps()-1,d=a+1,e=this.getHtmlElement();if(d>b)throw Error("Trying to set an invalid wizard step!");e.tabs("enable",d);e.tabs("option",
"active",d);0===a&&e.tabs("disable",a);d===b&&(a=this.getContinueButton(),a.button("option","label",this.getFinishButtonText()),a.button("enable"))};a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.tabsLoad=function(c,b,d){var e=this.getHtmlElement(),f=this.getProgressIndicator();if(2===d.tab.index()){e=a("#newFile",e);if(1!==e.length)throw Error('Did not find "new file" button!');e.button();e.bind("click",this.callbackWrapper(this.startWizard))}f.hide();return this.parent("tabsLoad",
...
function(){var a=this.getHtmlElement(),b=a.find('[name^="salesType"]:checked').val(),a=a.find('[id^="price"]');"openAccess"==b?(a.attr("disabled","disabled"),a.val("0")):"notAvailable"==b?(a.attr("disabled","disabled"),a.val("")):a.removeAttr("disabled")}})(jQuery);(function(a){a.pkp.controllers.grid.files=a.pkp.controllers.grid.files||{proof:{form:{}}};a.pkp.controllers.grid.files.proof.form.ApprovedProofFormHandler=function(c,b){this.parent(c,b);this.salesType_=b.salesType;c.find("#notAvailable, #openAccess, #directSales").click(this.callbackWrapper(this.checkHandler_));var d=a('input[id^="price"]');d.change(this.callbackWrapper(this.changeHandler_));""!==this.salesType_&&(""===d.attr("value")?(a("#notAvailable").attr("checked","true"),d.attr("disabled","true")):
"0"===d.attr("value")?(a("#openAccess").attr("checked","true"),d.attr("disabled","true").attr("value","")):a("#directSales").attr("checked","true"))};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.files.proof.form.ApprovedProofFormHandler,a.pkp.controllers.form.AjaxFormHandler);a.pkp.controllers.grid.files.proof.form.ApprovedProofFormHandler.prototype.salesType_=null;a.pkp.controllers.grid.files.proof.form.ApprovedProofFormHandler.prototype.checkHandler_=function(c){var b=a('input[id^="price"]');
...
function(c){var b=this.getHtmlElement();""!==a(c).val()?(this.audienceValues_=[b.find("#audienceRangeFrom").val(),b.find("#audienceRangeTo").val()],b.find("#audienceRangeFrom, #audienceRangeTo").val("").attr("disabled","disabled")):(b.find("#audienceRangeFrom, #audienceRangeTo").attr("disabled",""),b.find("#audienceRangeFrom").val(this.audienceValues_[0]),b.find("#audienceRangeTo").val(this.audienceValues_[1]))};a.pkp.controllers.catalog.form.CatalogMetadataFormHandler.prototype.checkAttachMetadata=
...
function(a){return this.categoryFetchUrlTemplate_.replace("CATEGORY_PATH",a)};a.pkp.pages.manageCatalog.ManageCatalogHeaderHandler.prototype.searchCatalogHandler_=function(c,b,d){var c=this.searchTabIndex_,b=a("#catalogTabs"),e=b.tabs("option","active");a("a[name='manageSearchResults']").attr("href",d);e===c?b.tabs("load",c):b.tabs("enable",c).tabs("option","active",c)};a.pkp.pages.manageCatalog.ManageCatalogHeaderHandler.prototype.selectSeriesHandler_=function(c,b,d){a("#seriesContainer").children().remove();
"0"!==d&&a.get(this.getSeriesFetchUrl_(d),this.callbackWrapper(this.showFetchedSeries_),"json")};a.pkp.pages.manageCatalog.ManageCatalogHeaderHandler.prototype.selectCategoryHandler_=function(c,b,d){a("#categoryContainer").children().remove();"0"!==d&&a.get(this.getCategoryFetchUrl_(d),this.callbackWrapper(this.showFetchedCategory_),"json")};a.pkp.pages.manageCatalog.ManageCatalogHeaderHandler.prototype.selectTabHandler_=function(c,b,d){var e,f;"categoryTab"==d.panel.id&&(e=a(c).find("#categorySelect"),
f=e.find("option").first().val(),void 0!==f&&(e.find("option").eq(0).attr("selected","selected"),this.selectCategoryHandler_(c,b,f)));"seriesTab"==d.panel.id&&(e=a(c).find("#seriesSelect"),d=e.find("option").first().val(),void 0!==d&&(e.find("option").eq(0).attr("selected","selected"),this.selectSeriesHandler_(c,b,d)));return!0};a.pkp.pages.manageCatalog.ManageCatalogHeaderHandler.prototype.showTabHandler_=function(){var c;a("#catalogTabs").tabs().tabs("option","active")!==this.searchTabIndex_&&(c=
this.getHtmlElement(),c.find('[id^="catalogSearch"]').val(""));return!0};a.pkp.pages.manageCatalog.ManageCatalogHeaderHandler.prototype.loadSpotlightsContent_=function(c){a.get(c,function(b){b=a.parseJSON(b);a("#spotlightsTab").html(b.content)})};a.pkp.pages.manageCatalog.ManageCatalogHeaderHandler.prototype.dataChangedHandler_=function(){var c=a("#catalogTabs").tabs(),b=c.tabs("option","active");switch(b){case 0:c.tabs("load",0);break;case 1:a("#selectCategoryForm",this.getHtmlElement()).trigger("containerReloadRequested");
