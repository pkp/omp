...
g;-1<a.inArray(g,d)||d.push(g)}return d}})(jQuery);(function(a){a.pkp.classes.features.OrderListbuilderItemsFeature=function(b,a){this.parent(b,a)};a.pkp.classes.Helper.inherits(a.pkp.classes.features.OrderListbuilderItemsFeature,a.pkp.classes.features.OrderItemsFeature);a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.addFeatureHtml=function(b,c){var d;this.parent("addFeatureHtml",b,c);b=this.getSequenceInput_();c=this.gridHandler.getRows();var e=0;for(d=c.length;e<d;e++){var g=a(c[e]);var k=b.clone();a("td.first_column",g).append(k)}};
