 ...
 *}
{include file="frontend/components/header.tpl" pageTitle="plugins.paymethod.paypal"}

<div class="page page_payment">
	{include file="frontend/components/breadcrumbs.tpl" currentTitleKey="plugins.paymethod.paypal"}
	...
	<form action="{$paypalFormUrl}" id="paypalPaymentForm" method="post" style="margin-bottom: 0px;">
		...
		<p><input type="submit" name="submitBtn" value="{translate key="common.continue"}" class="pkp_button"></p>
	</form>
