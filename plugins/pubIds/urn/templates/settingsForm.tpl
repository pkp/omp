	...
	{fbvFormArea id="urnSuffixFormArea" title="plugins.pubIds.urn.manager.settings.urnSuffix"}
		...
		{fbvFormSection list="true"}
			...
			{else}
				{assign var="checked" value=false}
			{/if}
			{fbvElement type="radio" id="urnSuffixCustomId" name="urnSuffix" value="customId" required="true" label="plugins.pubIds.urn.manager.settings.urnSuffixCustomIdentifier" checked=$checked}
		{/fbvFormSection}
		{fbvFormSection list="true"}
