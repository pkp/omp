...
class StampPressIdentityMetadata extends CommandLineTool
{
    ...
    /**
     * Press abbreviation per locale, as used in citations. Empty values are ignored.
     * e.g. ['en' => 'Old Abbrev.']
     *
     * @var array<string,string>|null
     */
    ...
    {
        echo "Re-stamps press identity metadata (name, abbreviation, publisher) onto publications\n"
            . "from the press's current settings. Only published publications are stamped;\n"
            . "unpublished ones are stamped when they are published.\n"
    ...
    /**
     * Stamp all published publications of a submission, returning the count stamped.
     */
