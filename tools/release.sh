...
#
# Script to create an automated (incremental) release of OMP.
#
# Usage: release.sh <stable-branch> <distrib dir> <github access token>
#  <stable_branch>: the stable branch to release from (e.g. omp-stable-1_1_1)
...
# Determine the tag of the last release on this branch (e.g. omp-1_1_1-0)
...
# Calculate the tag of the next release (e.g. omp-1_1_1-1
